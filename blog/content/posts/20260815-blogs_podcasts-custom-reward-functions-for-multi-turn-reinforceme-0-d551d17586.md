...
first_seen_at: 2026-08-15T09:40:14.446576Z
...
interpretation_sha256: "sha256:8dd1a0289b09be7fa12eed7ddbf0758846aee8f8f82cb6421ccb0b67dd9724d1"
description: "这段内容介绍了在多轮强化学习训练中如何设计组合奖励函数，并通过平台提供的自定义环境运行奖励逻辑，还说明了常见的奖励失效情形。"
...
last_seen_at: 2026-08-15T09:40:14.446576Z
---
...
### 这是什么
这段内容介绍了在多轮强化学习训练中如何设计组合奖励函数，并通过平台提供的自定义环境运行奖励逻辑，还说明了常见的奖励失效情形。

### 用在哪里
适用于需要通过自定义奖励来指导模型在多轮、具身代理任务（如工具调用、代码执行）中进行学习的开发者或团队。

### 可以推断的
推测：在多轮任务中，如果奖励的某个组成部分在所有轨迹上得分相同，则该部分不会贡献优势，导致梯度为零。  
推测：为了及时发现奖励失效，需要对每个奖励子项进行监控，以便在训练过程中检测到没有产生变化的指标。
