...
date: 2026-08-15T07:43:24+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-14T23:40:50.372147Z
...
interpretation_sha256: "sha256:91a5264cec5b5ead1942d4401a1f46b13f7329c04eb2621c2795c1494ca7d632"
description: "描述了如何为多轮强化学习设计自定义奖励函数，以及在 Amazon Nova Forge 环境中通过自行编排的方式执行奖励评分。"
...
last_seen_at: 2026-08-14T23:40:50.372147Z
---
...
### 这是什么
描述了如何为多轮强化学习设计自定义奖励函数，以及在 Amazon Nova Forge 环境中通过自行编排的方式执行奖励评分。

### 用在哪里
适用于需要在多轮交互、工具调用或代码执行等场景下对模型行为进行细粒度控制的团队，尤其是想使用自定义评分逻辑而不受单次 Lambda 超时限制的项目。

### 可以推断的
推测：在实际训练中，若奖励函数中某个权重项对所有样本得分相同，则该权重不会产生学习信号，导致模型优化被误导。  
推测：使用 LLM 作为评判器时，需要额外的安全防护措施，以免模型生成的内容触发不期望的奖励或产生风险。
