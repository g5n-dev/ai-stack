...
date: 2026-08-25T05:45:46+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-24T21:43:52.140630Z
...
interpretation_sha256: "sha256:e1abca04483821b4fb91eeb1878df1a71f1bebe1b9ddcec24953d436b715ebc9"
description: "该内容宣布在 Amazon SageMaker HyperPod 上新增 Ray 集成，使数据科学家能够在 SageMaker Studio 中直接创建和管理 Ray 集群、打开 Ray Dashboard 与可观测仪表板、提交分布式作业，并通过 KubeRay 与 HyperPod 的健康监控实现故障自动恢复。"
external_url: https://aws.amazon.com/blogs/machine-learning/introducing-new-ray-capabilities-on-sagemaker-hyperpod
parent_observation_id: null
last_seen_at: 2026-08-24T21:43:52.140630Z
---
...
### 这是什么  
该内容宣布在 Amazon SageMaker HyperPod 上新增 Ray 集成，使数据科学家能够在 SageMaker Studio 中直接创建和管理 Ray 集群、打开 Ray Dashboard 与可观测仪表板、提交分布式作业，并通过 KubeRay 与 HyperPod 的健康监控实现故障自动恢复。

### 用在哪里  
适用于在 AWS 上利用 GPU 集群进行大规模机器学习训练与模型服务的技术人员，尤其是已经在使用 SageMaker HyperPod 并希望借助 Ray 实现分布式 Python 工作流的团队。

### 可以推断的  
推测：该功能旨在降低对 Kubernetes YAML 编写和 kubectl 命令的依赖，让熟悉 Python 的数据科学家能够更直接地在托管环境中使用 Ray。  
推测：结合 JumpStart 与 Ray Serve 的集成，预先训练好的模型可更便捷地部署到 Ray 服务端点，从而简化从模型加载到在线推理的流程。
