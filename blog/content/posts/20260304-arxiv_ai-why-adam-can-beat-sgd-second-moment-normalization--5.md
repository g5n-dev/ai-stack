...
- 大模型
source: arxiv
description: 本文简要总结如下： 针对“为何 Adam 在实际应用中通常比随机梯度下降（SGD）收敛更快”这一核心问题，本文提出了新的理论解释。尽管 Adam
  表现优异，但现有理论大多仅给出与 SGD 相当的保证，无法充分解释两者在经验性能上的差距。 本文通过深入研究，揭示了 Adam 成功的关键在于其**二阶矩归一化**机制，并利
