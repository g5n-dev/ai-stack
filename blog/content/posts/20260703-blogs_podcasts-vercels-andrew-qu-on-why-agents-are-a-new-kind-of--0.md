...
description: Vercel 软件首席官解释了其代理框架 eve 的创建过程——以及为何技能、沙盒和可被代理读取的网站如今变得如此重要。 Vercel首席官Andrew
  Qu阐述代理为何成为一种全新的软件形态。当系统能够自行规划、调用技能并在沙盒环境中执行时，开发模式面临根本转变。文章深入剖析 eve 框架的设计思路，并提供在可被代理读取的网站上构建可扩展代理的实践要点。
