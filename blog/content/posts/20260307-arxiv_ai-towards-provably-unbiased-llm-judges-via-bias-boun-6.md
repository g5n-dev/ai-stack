...
- 论文
source: arxiv
description: 本文主要介绍了一种名为 **A-BB（Average Bias-Boundedness，平均偏差有界性）** 的算法框架，旨在解决大语言模型（LLM）作为评判者时存在的偏见问题，从而为构建可靠的自主
  AI 系统提供保障。 **背景与挑战：** 随着 AI 系统向自主化、自我维护的反馈回路发展，对可验证的自动奖励和反馈机
