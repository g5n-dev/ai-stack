...
- 论文
source: arxiv
description: '**总结：用户自定义需求下的多轮人机协作** 随着对话式AI在高风险决策场景中的应用日益广泛，如何确保多轮交互能可靠地提升决策质量成为关键挑战。本文提出了一种以用户为中心的人机协作框架，旨在通过两个核心原则——**反事实伤害**和**互补性**——来规范AI的行为，确保AI既能发挥优势又不削弱人类的能力。
  **核心内容'
