...
draft: false
entry_kind: "auto"
tags: ["Gemini", "科学研究", "数学发现", "案例研究", "AI for Science", "LLM", "DeepMind", "推理能力"]
categories: ["大模型", "论文"]
source: arxiv
description: "本文介绍了大型语言模型（特别是Google的Gemini系列）在加速科学研究，尤其是专家级数学发现方面的潜力。以下是内容总结： **核心成果：** 通过一系列案例研究，展示了研究人员如何利用Gemini模型（如Deep Think及其高级变体）在理论计算机科学、经济学、优化和物理学等领域取得突破。这些成就包括解决开放性"
