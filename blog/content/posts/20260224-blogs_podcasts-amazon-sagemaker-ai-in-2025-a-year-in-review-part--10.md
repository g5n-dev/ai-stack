...
description: '**标题：Amazon SageMaker AI 2025 年回顾（第一部分）：弹性训练计划与推理性价比提升** **摘要：** 2025
  年，Amazon SageMaker AI 在核心基础设施层面实现了显著进步。作为系列回顾的第一部分，本文重点介绍了在**容量**和**推理性价比**两个维度的关键更新，主要涵盖了'
