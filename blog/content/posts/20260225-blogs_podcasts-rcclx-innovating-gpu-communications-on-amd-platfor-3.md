...
description: '**RCCLX：创新 AMD 平台上的 GPU 通信技术** Meta 宣布开源 **RCCLX** 的初始版本。这是 Meta 在内部工作负载上开发并测试的
  AMD 平台通信库 RCCL 的增强版本。RCCLX 已与 Torchcomms 完全集成，旨在赋能研究人员和开发者，无论其使用何种后端，都能加速技术创新，以应'
