...
description: 平静的一天，让我们得以发布 OpenAI 研究员 Aidan McLaughlin 的一则思考。 在模型能力趋于同质化的当下，OpenAI
  研究员 Aidan McLaughlin 的最新思考为我们提供了一个审视技术发展的独特视角。本文探讨了为何在追求技术指标之外，提升对大语言模型（LLM）的期望值本身即是一种高回报的策略。
