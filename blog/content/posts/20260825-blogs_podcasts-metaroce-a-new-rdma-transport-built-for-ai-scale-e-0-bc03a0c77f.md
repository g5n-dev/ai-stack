...
first_seen_at: 2026-08-25T07:08:05.481027Z
...
interpretation_sha256: "sha256:53b12d1acdb29f4350d5398b5fef9ae48a7f73f0417655f9a9209a3e5ddc67f0"
description: "MetaRoCE 是一种专为大规模 AI 负载设计的 RDMA 传输协议，运行在普通以太网之上，把网络控制逻辑从交换机转移到终端网卡，实现逐路径遥测、包无序直接写入以及对拥塞的精细控制。"
external_url: https://engineering.fb.com/2026/08/24/networking-traffic/metaroce-rdma-transport-ai-ethernet
parent_observation_id: null
last_seen_at: 2026-08-25T07:08:05.481027Z
---
...
### 这是什么  
MetaRoCE 是一种专为大规模 AI 负载设计的 RDMA 传输协议，运行在普通以太网之上，把网络控制逻辑从交换机转移到终端网卡，实现逐路径遥测、包无序直接写入以及对拥塞的精细控制。

### 用在哪里  
适用于跨数据中心、拥有海量加速器的高性能 AI 训练和推理集群；网络设备供应商和 AI 基础设施团队可以利用该规范在现有的以太网交换平台上部署。

### 可以推断的  
- 推测：协议对交换机的需求仅限 ECN 标记与 ECMP 能力，因而可以在大多数商用以太网设备上直接实现，无需额外的专有功能。  
- 推测：通过为每条路径独立维护窗口和往返时间估算，拥塞或故障的链路只会影响所在路径，而不会导致整体连接停顿，这有助于在多路径并行传输时保持低尾延迟。
