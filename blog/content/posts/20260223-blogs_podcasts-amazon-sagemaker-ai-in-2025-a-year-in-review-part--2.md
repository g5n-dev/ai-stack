...
description: '**亚马逊 SageMaker AI 2025 年度回顾（第一部分）摘要** 2025年，亚马逊 SageMaker AI 在核心基础设施方面取得了显著进步，主要体现在**容量、性价比、可观测性和易用性**这四个维度。
  本系列文章将详细探讨这些改进及其带来的优势。作为系列的第一部分，本文重点介绍了以下两方面的内容： 1'
