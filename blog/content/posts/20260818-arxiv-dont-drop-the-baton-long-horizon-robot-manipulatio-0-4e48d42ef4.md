...
first_seen_at: 2026-08-18T13:56:44.644683Z
...
interpretation_sha256: "sha256:108fd13f710bd571721f6a9d727d32dd949abe9c9d960c0b067dc99b5d711c31"
description: "BATON是一种在长时程机器人操作中，把子任务作为探索单元并引入对转换状态的感知记忆，以降低整体搜索成本并确保子任务间衔接的框架。"
external_url: http://arxiv.org/abs/2608.16889v1
parent_observation_id: null
last_seen_at: 2026-08-18T13:56:44.644683Z
---
...
### 这是什么
BATON是一种在长时程机器人操作中，把子任务作为探索单元并引入对转换状态的感知记忆，以降低整体搜索成本并确保子任务间衔接的框架。

### 用在哪里
适用于需要把多个接触密集的动作串联成多阶段任务、并借助视觉-语言-动作模型进行控制的机器人系统。

### 可以推断的
推测：该方法通过在子任务层面保存成功经验，能够在同类任务中实现零样本迁移。  
推测：若在更多机器人平台加入类似的转换感知机制，可能会进一步提升长时程任务的成功率。
