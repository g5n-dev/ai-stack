...
- 系统与基础设施
source: arxiv
description: 模仿学习常受限于数据收集的低效，传统开环采集难以针对性覆盖策略缺陷，而依赖物理机器人的交互式方法又成本高昂。RoboPocket 提出了一种利用智能手机的便携式系统，通过
  AR 技术可视化策略轨迹，让操作者无需实体机器人即可识别并补充失败场景的数据。实验表明，该系统遵循数据缩放定律，且相比传统离线方法将数据效率提升了一倍，为机器人策略的即时迭代提供了低成本的新路径。
