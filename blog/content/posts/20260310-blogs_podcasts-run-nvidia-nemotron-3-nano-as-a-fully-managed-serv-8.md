...
description: '**内容总结：** NVIDIA 宣布其 **Nemotron 3 Nano** 模型现已作为**完全托管的无服务器模型**正式上线 **Amazon
  Bedrock**。 这是继此前在 AWS re:Invent 大会上宣布支持 Nemotron 2 Nano 9B 和 Nemotron 2 Nano VL
  12B'
