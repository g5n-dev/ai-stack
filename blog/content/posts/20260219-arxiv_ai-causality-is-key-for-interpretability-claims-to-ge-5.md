...
- 论文
source: arxiv
description: 针对大语言模型可解释性研究中发现难以普适及因果推断证据缺失的问题，本文引入Pearl因果层级与因果表示学习理论，旨在界定从模型激活到高层结构的有效映射。作者提出了一个诊断框架，以规范干预实验与反事实声明所需的假设，从而确保研究结论的科学严谨性。该框架虽为从业者选择评估方法提供了理论依据，但其在复杂模型中的具体应用效果尚无法从摘要确认。
