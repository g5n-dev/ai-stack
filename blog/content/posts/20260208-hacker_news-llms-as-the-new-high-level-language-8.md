...
- AI 工程
source: hacker_news
description: 随着大语言模型（LLM）能力的快速迭代，一种新的编程范式正在悄然形成：自然语言正逐渐演变为继汇编、C 和 Python 之后的“下一代高级语言”。这一转变不仅意味着我们可以用更直观的方式指挥计算机，更预示着软件开发流程的底层逻辑将发生根本性重构。本文将深入探讨这一趋势，分析
  LLM 如何从单纯的辅助工具转变为系统的核心
