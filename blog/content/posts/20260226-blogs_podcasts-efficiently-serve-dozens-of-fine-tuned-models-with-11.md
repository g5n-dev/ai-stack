...
description: 本文介绍了如何在 Amazon SageMaker AI 和 Amazon Bedrock 上利用 vLLM 高效托管数十个微调模型，重点阐述了混合专家（MoE）模型的多
  LoRA 推理实现及内核优化，并以 GPT-OSS 20B 为例展示了实际应用价值。主要内容包括： 1. **多 LoRA 推理架构** vLLM
