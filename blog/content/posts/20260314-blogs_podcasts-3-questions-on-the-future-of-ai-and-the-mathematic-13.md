...
draft: false
entry_kind: "auto"
tags: ["AI for Science", "数理科学", "交叉融合", "Jesse Thaler", "MIT", "双向赋能", "科学范式", "未来趋势"]
categories: ["大模型", "论文"]
source: blogs_podcasts
description: "**核心观点：建立人工智能与数理科学的双向桥梁** 麻省理工学院教授 Jesse Thaler 提出了一种关于人工智能（AI）与数学及物理科学未来关系的愿景。他主张不应将 AI 仅视为辅助工具，而应构建一座**“双向桥梁”**（two-way bridge），使 AI 与数理科学相互促进、共同发展。 **主要内容总结："
...
### 如何应用到自己的项目
1.  **识别物理约束：** 在你的项目中，有哪些是不变的物理量或守恒定律？（如能量守恒、质量守恒）。
2.  **数据预处理：** 利用数学变换（如傅里叶变换）将数据转换到更适合神经网络处理的流形空间。
3.  **模型选择：** 优先选择具有几何先验的模型（如图神经网络GNN处理分子结构）。
