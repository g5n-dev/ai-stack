...
- 论文
source: arxiv
description: 针对网络智能体在真实环境中训练面临的高成本与潜在风险问题，本文提出了基于模型强化学习的 DynaWeb 框架。该研究通过构建能够模拟网页交互的“世界模型”，使智能体能够在合成环境中进行策略推演与“想象”训练，从而显著提升样本效率。虽然摘要未明确提及具体任务性能的提升幅度，但该框架为解决网络智能体的高效训练与安全部署提供了新的技术路径。
