...
description: "以下是内容的中文总结： NVIDIA 的 Nemotron 3 Nano 模型现已在 Amazon Bedrock 上作为完全托管的无服务器模型正式推出。此前在 AWS re:Invent 大会上，双方已宣布支持 Nemotron 2 Nano 9B 和 Nemotron 2 Nano VL 12B 模型。本文将深入探"
