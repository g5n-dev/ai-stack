...
- 论文
source: arxiv
description: 针对现有视觉生成基准多侧重于静态知识回忆而忽视“流体智力”的问题，本文提出了 GENIUS 评估套件，旨在量化模型在即时语境中归纳模式、执行约束及适应新场景的综合能力。通过对主流模型的系统评估，研究揭示了其在语境理解层面的显著缺陷，并据此提出了一种无需训练的注意力干预策略以优化性能。该工作为未来提升生成模型的动态推理与泛化能力提供了新的评测视角与技术路径。
