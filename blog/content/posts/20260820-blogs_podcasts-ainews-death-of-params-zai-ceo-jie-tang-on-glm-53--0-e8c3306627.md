...
date: 2026-08-20T13:49:24+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-20T05:46:00.314864Z
...
interpretation_sha256: "sha256:25abc5ca3084a7c207114f6410c193c74f9dca5c835539ab140f253902f3a605"
description: "Prof Jie Tang在演讲中指出，仅靠参数规模已不足以衡量模型能力，GLM 5.3通过在真实工作流程构建的多步、可验证的强化学习环境实现显著提升，强调数据、算力分配和部署条件等多因素的重要性。"
external_url: https://www.latent.space/p/ainews-death-of-params-zai-ceo-jie
parent_observation_id: null
last_seen_at: 2026-08-20T05:46:00.314864Z
---
...
### 这是什么
Prof Jie Tang在演讲中指出，仅靠参数规模已不足以衡量模型能力，GLM 5.3通过在真实工作流程构建的多步、可验证的强化学习环境实现显著提升，强调数据、算力分配和部署条件等多因素的重要性。

### 用在哪里
适用于关注大模型后训练、强化学习环境构建以及模型评估体系的研究者和工程师，尤其是关注开源权重模型和训练效率的团队。

### 可以推断的
推测：未来模型优化将把数据质量、算力投入和环境可执行性作为关键指标，而非单纯扩大参数规模。  
推测：构建大规模、可自动生成的训练任务环境将成为研发竞争的核心技术之一。
