...
draft: false
entry_kind: "auto"
tags: ["LLM", "OpenAI", "Prompt Engineering", "模型优化", "系统提示", "AI 思维", "高回报策略", "模型能力"]
categories: ["大模型", "AI 工程"]
source: blogs_podcasts
description: "**内容总结：** 本文主要分享了OpenAI研究员Aidan McLaughlin关于提升大语言模型（LLM）性能的一项“高回报”策略：**提高你的期望值**。 尽管当天AI新闻较为平淡，但作者借机传达了一个核心观点。与其仅仅关注复杂的架构调整或海量数据投喂，研究人员和开发者应当尝试从心理和系统提示层面，对LLM抱有"
