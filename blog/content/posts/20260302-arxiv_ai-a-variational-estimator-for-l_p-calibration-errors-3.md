...
- 数据
source: arxiv
description: 准确评估多分类场景下的校准误差对于保障机器学习系统的可靠性至关重要。本文提出了一种基于变分框架的新方法，将校准误差的估计范围从传统的恰当损失函数扩展至更广泛的
  $Lp$ 散度。该方法不仅能有效区分模型的过度自信与自信不足，还通过变分手段缓解了非变分方法中常见的高估问题。虽然具体的理论收敛速度无法从摘要确认，但作者已将相关代码集成至开源库，有望为后续研究提供更稳健的校准评估工具。
