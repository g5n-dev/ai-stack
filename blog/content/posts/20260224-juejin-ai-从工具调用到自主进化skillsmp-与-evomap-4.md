...
draft: false
entry_kind: "auto"
tags: ["AI Agent", "MCP", "SkillSMP", "EvoMap", "GEP", "技术栈演进", "工具调用", "自主进化"]
categories: ["大模型", "AI 工程"]
source: juejin
description: "AI Agent 演进：从工具调用到自主进化 AI Agent（智能体）正从“单体玩具”向“生产力工具”快速进化，其技术栈演进路径可概括为：**MCP（模型控制协议）→ Skill（技能化）→ GEP（通用进化范式）**。 1. **MCP：工具调用的起点** 早期 AI Agent 依赖 **MCP（Model Co"
