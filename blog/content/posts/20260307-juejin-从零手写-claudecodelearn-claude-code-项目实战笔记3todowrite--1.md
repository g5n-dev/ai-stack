...
draft: false
entry_kind: "auto"
tags: ["ClaudeCode", "Agent", "LLM", "长链路", "记忆机制", "TodoWrite", "上下文管理", "状态固化"]
categories: ["AI 工程", "大模型"]
source: juejin
description: "本文总结《从零手写 ClaudeCode：learn-claude-code 项目实战笔记》第3阶段（s03）的核心内容——**TodoWrite（待办写入）功能**。 1. 核心痛点 在长链路任务中，大模型（LLM）容易出现“健忘”现象。当任务步骤繁多时，模型往往在执行后续步骤时遗忘了前置的设定或中间结果，导致任务失"
