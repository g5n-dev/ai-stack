...
- AI 工程
source: arxiv
description: 针对同策略强化学习中连续动作控制面临的挑战，本文提出了 RN-D 算法，通过引入离散化分类行动者与正则化网络来优化策略表达。该方法利用离散分布逼近连续动作空间，并借助正则化手段提升训练稳定性。虽然其具体的收敛性理论尚无法从摘要确认，但该工作为在策略算法在复杂环境下的高效探索与稳定学习提供了新的技术路径。
