...
draft: false
entry_kind: "auto"
tags: ["拆分计算", "边缘计算", "模型适配", "端侧推理", "隐私计算", "SALT", "cs.LG", "轻量化"]
categories: ["AI 工程", "系统与基础设施"]
source: arxiv
description: "以下是对该内容的中文总结： 针对**封闭式分割计算**（Split Computing）在实际部署中面临的性能下降问题，本文提出了一种名为**SALT**（Split-Adaptive Lightweight Tuning，分割自适应轻量级调优）的轻量级适应框架。 **背景与挑战：** 分割计算通过将深度神经网络切分为"
...
**A**: 根据该论文的研究思路，其轻量级特性通常通过以下几种技术手段实现（具体取决于论文采用的详细技术，如基于适配器 Adapter 或 特征变换等）：
