...
draft: false
entry_kind: "auto"
tags: ["OpenAI", "GPT 5.4", "CUA", "SOTA", "代码生成", "Agent", "知识工作", "模型发布"]
categories: ["大模型", "AI 工程"]
source: blogs_podcasts
description: "这篇文章主要报道了OpenAI发布的最新模型 **GPT 5.4**，称其标志着OpenAI的强势回归（\"so very back\"）。 以下是核心内容的总结： 1. **全能型新王**：GPT 5.4被描述为一个结合了**知识工作**、**编程**以及 **CUA（计算机使用代理/Computer Using Age"
