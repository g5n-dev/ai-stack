...
description: 随着 AI 系统的日益强大，如何准确评估其潜在风险已成为安全研究的核心议题。METR 研究员 Joel Becker 在本次访谈中深入探讨了指数级时间视界评估、威胁模型定义，以及
  AI 生产力在实际应用中的边界。这篇文章将帮助读者理解前沿的评估框架，并厘清在追求技术效率时不可忽视的安全局限。
