...
draft: false
entry_kind: "auto"
tags: ["RVR", "RAG", "检索增强", "多轮检索", "问答系统", "Verifier", "信息检索", "Arxiv"]
categories: ["大模型", "论文"]
source: arxiv
description: "以下是关于《RVR: Retrieve-Verify-Retrieve for Comprehensive Question Answering》的简洁总结： **核心目标** 为了解决那些具有多种有效答案的复杂查询，本文提出了一种名为 **RVR（检索-验证-检索）** 的多轮检索框架，旨在最大化答案的覆盖率，确保全"
