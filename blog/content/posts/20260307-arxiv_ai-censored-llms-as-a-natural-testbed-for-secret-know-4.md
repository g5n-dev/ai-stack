...
在这篇论文的语境下，“秘密知识”特指那些被模型开发者标记为敏感、有害或不适合公开的信息。这通常包括制造生物武器的详细步骤、黑客攻击代码、仇恨言论内容或其他违反伦理准则的指令。这与模型的一般能力（如解决数学问题、编写代码或翻译文本）有本质区别。模型具备“一般能力”是指它能理解并处理任务，而“秘密知识”是指它存储了特定的、被禁止的事实或程序。研究的关键点在于，模型虽然被训练得拒绝*展示*这些知识，但它并没有真正*忘记*这些知识。
