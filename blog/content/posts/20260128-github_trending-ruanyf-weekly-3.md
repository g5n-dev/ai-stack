...
draft: false
entry_kind: "auto"
tags: ["技术周刊", "阮一峰", "Newsletter", "技术趋势", "资源聚合", "Markdown", "深度解读", "GitHub"]
...
### 阮一峰的周刊中包含大量实用工具推荐。请尝试在本地搭建一个简易的“周刊阅读器”：编写一个脚本，从周刊的 HTML 存档中提取**最近 10 期**的标题，并生成一个包含链接的 Markdown 目录索引。
