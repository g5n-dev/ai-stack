...
first_seen_at: 2026-08-20T01:51:56.822560Z
...
interpretation_sha256: "sha256:3556fc26a35732ad0621998198bb8048c8d4cc63491ab3ef3308f3c432d66cde"
description: "该功能为 Web Search 工具新增了运行时域名过滤和发布‑日期范围限制，使调用方能够在每一次请求时精准控制检索的来源网站和内容时效，并结合已有的管理员级策略形成层级化过滤模型。"
...
last_seen_at: 2026-08-20T01:51:56.822560Z
---
...
### 这是什么
该功能为 Web Search 工具新增了运行时域名过滤和发布‑日期范围限制，使调用方能够在每一次请求时精准控制检索的来源网站和内容时效，并结合已有的管理员级策略形成层级化过滤模型。

### 用在哪里
适用于需要在对话代理中确保信息来源合规或内容新鲜的开发者，尤其在金融、产品客服或受监管行业的 AI 代理场景下，可动态收紧或放宽检索范围。

### 可以推断的
推测：服务端统一执行过滤逻辑，客户端无需额外处理，可降低集成复杂度并提升响应一致性。  
推测：区域扩展至欧洲和亚太后，位于这些地区的用户可获得更低的延迟，并满足当地数据驻留的合规要求。
