...
first_seen_at: 2026-08-19T22:40:37.471095Z
...
interpretation_sha256: "sha256:699cd09f2aecc4636efc5dc641ab1c55346bdde8f6c5903ae82e5c69e77d5288"
description: "该内容介绍了 Amazon Bedrock AgentCore 平台上 Web Search 功能的增强，新增了运行时域名过滤和发布日期过滤能力，允许开发者在 API 调用时动态指定允许或禁止搜索的域名范围，以及内容发布时间窗口。"
...
last_seen_at: 2026-08-19T22:40:37.471095Z
---
...
### 这是什么
该内容介绍了 Amazon Bedrock AgentCore 平台上 Web Search 功能的增强，新增了运行时域名过滤和发布日期过滤能力，允许开发者在 API 调用时动态指定允许或禁止搜索的域名范围，以及内容发布时间窗口。

### 用在哪里
适用于需要严格控制 AI 代理信息来源的业务场景，例如金融领域的合规代理只搜索政府或认证机构域名，产品信息代理确保搜索结果的时效性，多租户平台根据不同客户需求动态调整搜索策略，以及客服代理获取最新文档版本等。

### 可以推断的
推测：此类精细化的搜索控制功能反映了企业级 AI 应用对信息来源可控性的普遍需求，随着生成式 AI 在关键业务场景的深入应用，对搜索结果的可信度和时效性要求会进一步提升。
推测：分层过滤模型（管理员级别策略 + 运行时调用控制）的设计兼顾了企业治理和灵活定制两个层面，这种思路可能会被后续其他平台的功能设计所借鉴。
