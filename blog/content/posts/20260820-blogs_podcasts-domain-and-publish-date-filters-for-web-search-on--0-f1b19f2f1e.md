...
first_seen_at: 2026-08-20T04:52:39.479082Z
...
interpretation_sha256: "sha256:698240adc350bd111d0899fe7aa87653052720e84aedecfc4c9889d03082a04d"
description: "这是一项面向 AI 代理平台的新功能，允许在调用网络搜索时通过参数指定可搜索的域名范围和内容发布时间窗口，从而对代理检索的信息来源实现更细粒度的控制。"
...
last_seen_at: 2026-08-20T04:52:39.479082Z
---
...
### 这是什么
这是一项面向 AI 代理平台的新功能，允许在调用网络搜索时通过参数指定可搜索的域名范围和内容发布时间窗口，从而对代理检索的信息来源实现更细粒度的控制。

### 用在哪里
需要严格限制信息来源的场景会用到，例如合规类代理只能搜索特定机构发布的文档，或者客服代理需要排除过时的产品信息。该功能面向在平台上构建代理的开发者和企业。

### 可以推断的
推测：该功能采用服务端执行的方式，搜索请求全程在平台内部处理，不需要额外的客户端处理步骤。
推测：这种过滤机制在保证灵活性的同时预设了安全边界，运行时的过滤范围只能在管理员设定的策略范围内收窄，而无法突破。
