...
description: '**总结：NVIDIA Nemotron 3 Nano 现已登陆 Amazon Bedrock** NVIDIA Nemotron 3
  Nano 模型现已作为完全托管的无服务器模型在 Amazon Bedrock 上线。这一发布是对此前在 AWS re:Invent 大会上宣布支持 NVIDIA
  Nemotron 2'
