...
date: 2026-03-09 14:04:55+08:00
draft: false
entry_kind: auto
tags:
- OpenAI
...
description: 以下是该内容的中文总结： **核心发现：难以控制的思维链** OpenAI 在最新的研究中引入了一种名为 **“CoT-Control”（思维链控制）**
  的评估机制。该研究旨在测试推理模型是否有能力在生成答案的过程中，主动监控并修正其内部生成的“思维链”。然而，结果显示，当前的推理模型在控制自身的思维过程方面表现出了
