...
draft: false
entry_kind: "auto"
tags: ["编程代理", "代码开发", "工程类比", "AI辅助编程", "软件开发", "自动化", "系统设计", "波音747"]
...
**A**: "747s" 指的是波音 747 飞机，即著名的"空中客车"（Jumbo Jet）。在软件工程和 AI 讨论的语境中，它通常被用作隐喻，指代那些**庞大、复杂、集中式且极其昂贵的系统**。
...
**A**: Coding Agents 是一种能够**自主规划和执行复杂软件工程任务**的 AI 系统。与传统的 AI 编程助手有本质区别：
...
**A**: 文章通常认为这不会取代工程师，而是极大地**改变工程师的工作性质**：
...
**A**: 不一定。文章并非认为大型模型（LLM）会消失，而是认为**单纯依赖规模扩张的战略正在遇到瓶颈**。
