...
draft: false
entry_kind: "auto"
tags: ["DeepSeek", "OCR", "Token优化", "代码重构", "AI辅助编程", "PDF", "成本优化", "上下文窗口"]
categories: ["AI 工程", "开发工具"]
source: juejin
description: "这篇文章总结如下： **核心观点：** 对于复杂代码模块的 AI 辅助重构，直接复制纯文本代码会消耗大量 Token 并容易超出上下文限制。作者通过开发一个工具验证了“**DeepSeek-OCR 猜想**”：将代码转换为 **PDF 图片**后，利用 OCR 能力让 AI 读取，可比直接传输文本节省 **40% 的"
