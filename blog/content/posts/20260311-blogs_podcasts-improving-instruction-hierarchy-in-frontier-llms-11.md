...
description: 以下是针对该内容的中文总结： 这项工作致力于提升前沿大语言模型（LLM）的**指令层级**能力，核心在于开发了一个名为 **IH-Challenge**
  的训练框架。 **核心目标：** IH-Challenge 旨在解决模型在面对复杂或冲突指令时的优先级判断问题。通过特定训练，模型能够学会优先遵循“可信指令”（即系统
