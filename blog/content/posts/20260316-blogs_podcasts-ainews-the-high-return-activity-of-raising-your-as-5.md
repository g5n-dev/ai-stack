...
draft: false
entry_kind: "auto"
tags: ["LLM", "OpenAI", "Prompt技巧", "AI交互", "模型能力", "Aidan McLaughlin", "智能体", "涌现能力"]
categories: ["大模型", "效率与方法论"]
source: blogs_podcasts
description: "**标题：提升 LLM 期望值的“高回报”活动** **来源：** [AINews] / Aidan McLaughlin (OpenAI 研究员) **核心观点：** 在 AI 发展相对平静的时期，OpenAI 研究员 Aidan McLaughlin 分享了一个关于如何与大语言模型（LLM）互动的高回报策略，即“提"
...
### 如何应用到自己的项目
1.  **建立“困难样本”数据集**：收集你的业务中最难解决的10%的问题，专门用来测试模型。
2.  **设计“压力测试”流程**：在开发流程中加入“极限挑战”环节，不要满足于平均分。
3.  **利用Chain of Thought**：强制模型输出思考过程，这通常能通过提高任务显式难度来提升结果质量。

### 知识补充
需要深入学习**Prompt Engineering中的“思维链提示”**和**“角色扮演的高级技巧”**。
