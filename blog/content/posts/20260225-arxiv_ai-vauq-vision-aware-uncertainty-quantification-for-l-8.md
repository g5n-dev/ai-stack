...
- 论文
source: arxiv
description: 以下是针对 **VAUQ (Vision-Aware Uncertainty Quantification)** 论文的中文总结： **论文背景**
  大型视觉语言模型（LVLM）在实际应用中经常面临“幻觉”问题（即生成与图像内容不符的文本），限制了其安全部署。现有的自我评估方法主要依赖大模型的语言先验能力来判断自身输出
