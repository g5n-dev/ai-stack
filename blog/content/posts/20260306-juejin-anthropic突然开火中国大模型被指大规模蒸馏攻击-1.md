...
- 安全
source: juejin
description: 随着大模型竞争从单纯的参数比拼转向数据与规则的博弈，行业内的技术摩擦正逐渐公开化。Anthropic 近期公开指责中国大模型存在“蒸馏”行为，将原本暗流涌动的技术合规问题推向了台前。本文将梳理此次事件的来龙去脉，分析“蒸馏”争议背后的技术界定与行业影响，帮助读者理解在日益激烈的全球竞争中，技术边界与数据安全正成为新的核心焦点。
