...
draft: false
entry_kind: "auto"
tags: ["行为学习", "分层优化", "可解释性", "符号表示", "通用逼近", "cs.LG", "开源", "机器学习框架"]
categories: ["大模型", "论文"]
source: arxiv
description: "受行为科学启发，本文提出了一种名为**行为学习**的新型通用机器学习框架。BL 旨在从数据中学习可解释且可识别的优化结构，应用范围涵盖单个优化问题到分层结构。 **核心特点：** 1. **统一性：** 能够同时兼顾预测性能、内在的可解释性以及模型的可识别性。 2. **模块化架构：** BL 将组合效用函数参数化为由"
