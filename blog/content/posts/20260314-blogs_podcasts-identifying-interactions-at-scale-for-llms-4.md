...
description: 这篇文章介绍了一种名为 **SPEX** 和 **ProxySPEX** 的算法，旨在解决大型语言模型（LLMs）可解释性研究中的核心挑战：**在大规模系统中识别关键的交互作用**。
  **核心问题：** 理解复杂的机器学习系统（尤其是LLMs）对于构建安全可信的AI至关重要。现有的可解释性研究通常从三个角度切入： 1.
