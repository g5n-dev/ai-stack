...
date: 2026-08-16T21:04:00+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-16T13:00:42.598926Z
...
interpretation_sha256: "sha256:89fad7ec44676b96b5cee0d51e7461c98f622901ab6e538fac190424b03598c9"
description: "Flue 2 是一个把代理实现成 JavaScript 函数并借助 React 风格的钩子（hooks）在每次模型调用前“重新渲染”的框架，提供了状态管理、生命周期监听和运行时动态挂载工具、子代理等能力，底层跑在开源的轻量 harness “Pi”之上。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T13:00:42.598926Z
---
...
### 这是什么
Flue 2 是一个把代理实现成 JavaScript 函数并借助 React 风格的钩子（hooks）在每次模型调用前“重新渲染”的框架，提供了状态管理、生命周期监听和运行时动态挂载工具、子代理等能力，底层跑在开源的轻量 harness “Pi”之上。

### 用在哪里
适合需要让代理在对话或工作流中实时调整自身配置的支持机器人、分类机器人等场景；同样面向想把 AI 编程代理做成无头、可编程产品的开发者。

### 可以推断的
推测：随着更多框架把 harness 作为代理的核心抽象，业界的开发模式可能逐渐从“脚本化驱动 LLM”转向“在受控环境中让代理自行决策”。  
推测：Flue 与 Vercel 的 eve 在把 harness 视为基础这一点上相似，未来两者有望在生态、组件复用等方面展开竞争或合作。
