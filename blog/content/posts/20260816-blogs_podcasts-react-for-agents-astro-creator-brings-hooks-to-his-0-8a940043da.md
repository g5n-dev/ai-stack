...
date: 2026-08-16T13:45:08+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-16T05:42:20.965530Z
...
interpretation_sha256: "sha256:79663004311a4374b284d7b4be00ad38acd157c652ca767d7742b163c57f47a3"
description: "Flue 2 是一套面向开发者的代理框架，采用 React 风格的 Hooks，使代理在每次模型调用前重新渲染，支持动态状态管理和资源挂载。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T05:42:20.965530Z
---
...
### 这是什么
Flue 2 是一套面向开发者的代理框架，采用 React 风格的 Hooks，使代理在每次模型调用前重新渲染，支持动态状态管理和资源挂载。

### 用在哪里
适用于需要在对话或工作流中动态组合技能、工具或子代理的场景，如客服、事务路由、自动化脚本等，适合使用 AI 编程助手的开发者或平台团队。

### 可以推断的
推测：基于 React 组合思想的 Hooks 可能在更多代理框架中被采用，以实现动态、可组合的代理行为。  
推测：代理框架将把“harness”视为必备基础，而非可选特性，从而推动工具链向统一、可嵌入的方向演进。
