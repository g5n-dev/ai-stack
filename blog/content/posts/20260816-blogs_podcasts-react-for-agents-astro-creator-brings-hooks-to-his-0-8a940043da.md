...
date: 2026-08-16T16:49:33+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-16T08:46:49.348633Z
...
interpretation_sha256: "sha256:2b6fd181db333e455067c218c62fe7da8530893e4622798d0fc16803d3c45cd2"
description: "Flue 2 是一个面向开发者的代理框架，核心是把 React 风格的 Hooks 引入代理实现，使代理能够在每次模型调用前重新渲染并动态挂载资源。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T08:46:49.348633Z
---
...
### 这是什么
Flue 2 是一个面向开发者的代理框架，核心是把 React 风格的 Hooks 引入代理实现，使代理能够在每次模型调用前重新渲染并动态挂载资源。

### 用在哪里
适合需要构建可随对话或工作流自行调整状态的代理应用的团队，尤其是想利用可组合的模块（如技能、工具、子代理）来快速搭建支持或分类机器人的开发者。

### 可以推断的
推测：随着 Hooks 模式在代理开发中的推广，更多框架可能会采用类似的动态组合机制，以提升代理的灵活性。  
推测：该方案将“代理必须有 harness”这一理念进一步落实，可能成为后续代理框架设计的共识。
