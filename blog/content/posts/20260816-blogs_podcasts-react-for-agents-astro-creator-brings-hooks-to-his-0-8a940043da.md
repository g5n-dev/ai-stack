...
date: 2026-08-16T09:58:56+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-16T01:57:22.086169Z
...
interpretation_sha256: "sha256:1dd5ae1e300c33faa5c2c492498bc95cae2066f1007eb05ce6f39f997ea87492"
description: "Flue 2 通过类似 React 的钩子机制，让代理（Agent）以 JavaScript 函数形式存在，并在每次模型调用前重新渲染，从而实现动态状态管理和资源组合。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T01:57:22.086169Z
---
...
### 这是什么
Flue 2 通过类似 React 的钩子机制，让代理（Agent）以 JavaScript 函数形式存在，并在每次模型调用前重新渲染，从而实现动态状态管理和资源组合。

### 用在哪里
面向需要在对话或工作流中实时调整功能集的开发者，适用于构建能够自行调用工具、监听生命周期事件并随时添加子代理的智能系统，例如客服或分类类机器人。

### 可以推断的
推测：受前端组件化思想启发，未来会出现更多把“钩子”或可插拔模块作为核心概念的代理开发方案，以提升代码复用和动态配置能力。  
推测：围绕代理的运行环境（即所谓的“harness”）的标准化和可扩展性，将成为框架竞争的关键差异点。
