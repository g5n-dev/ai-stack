...
first_seen_at: 2026-08-16T09:41:20.644110Z
...
interpretation_sha256: "sha256:ac605351d59607187eebf5f17236e2a042f091bb6d1ee57736b5e34705ce4ce3"
description: "Flue 2 是由 Astro 框架作者基于 React 风格的 Hooks 打造的代理（Agent）开发平台，搭建在开源的最小化 Harness（Pi）之上，旨在让代理能够自行管理状态、监听生命周期并按需挂载工具或子代理。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T09:41:20.644110Z
---
...
### 这是什么
Flue 2 是由 Astro 框架作者基于 React 风格的 Hooks 打造的代理（Agent）开发平台，搭建在开源的最小化 Harness（Pi）之上，旨在让代理能够自行管理状态、监听生命周期并按需挂载工具或子代理。

### 用在哪里
适用于需要随对话或工作流实时调整能力的客服、分类等场景，也是希望在代码中组合、可编程地部署代理的开发者，尤其是熟悉 React 的前端工程师的上手工具。

### 可以推断的
- 推测：随着 Hooks 模式在代理框架中的普及，更多框架会借鉴 React 的可组合性来提升动态代理的灵活性。  
- 推测：Harness 作为代理核心的概念可能成为后续代理平台的标准设计思路，促使框架在运行时提供统一的上下文和资源访问接口。
