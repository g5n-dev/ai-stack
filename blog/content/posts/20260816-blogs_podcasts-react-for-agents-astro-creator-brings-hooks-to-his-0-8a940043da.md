...
date: 2026-08-16T23:38:09+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-16T15:35:24.313722Z
...
interpretation_sha256: "sha256:9194ef09926bd7b6c4d49f24ecd47bc9513df99946a1bfd1f3b0bd30e7401595"
description: "Flue 2 是 Fred Schott 推出的 Agent 框架，采用 React 风格的 Hooks 把 Agent 实现为可动态组合的函数，实现运行时状态管理和资源挂载。"
external_url: https://www.latent.space/p/flue-2
parent_observation_id: null
last_seen_at: 2026-08-16T15:35:24.313722Z
---
...
### 这是什么
Flue 2 是 Fred Schott 推出的 Agent 框架，采用 React 风格的 Hooks 把 Agent 实现为可动态组合的函数，实现运行时状态管理和资源挂载。

### 用在哪里
适用于需要在对话或工作流中实时调整行为、挂载不同工具或子 Agent 的后端开发者或 AI 应用构建者。

### 可以推断的
- 推测：Hooks 机制使 Agent 在每次模型调用前重新渲染，从而更易实现上下文感知的动态行为。  
- 推测：基于 Pi 的底层 harness 强调 Agent 与环境的分离，未来可能与 Vercel 的 eve 等同类框架在可插拔性和云端部署上展开竞争。
