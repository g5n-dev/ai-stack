...
description: 本文介绍了 Amazon Bedrock AgentCore 中的 Policy 功能，旨在通过策略层保障 AI Agent 的安全性。Policy
  提供了一个独立于 Agent 自主推理能力的确定性执行层，确保 Agent 的行为受到严格控制。 用户可以将业务规则的**自然语言描述**转化为 Cedar 策略，利用这
