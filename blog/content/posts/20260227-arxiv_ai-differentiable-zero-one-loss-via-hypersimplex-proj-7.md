...
- AI 工程
source: arxiv
description: 针对0-1损失函数因不可微而难以直接用于梯度优化这一经典难题，本文提出了一种基于超单纯形投影的微分近似方法。该方法在保持分类任务“金标准”性能指标的同时，通过投影变换构建了可微的代理损失，从而为神经网络训练提供了新的优化路径。由于摘要信息截断，具体的收敛性证明及计算开销目前无法从摘要确认，但该工作若能有效平衡精度与效率，有望在需要严格分类评估的场景中替代传统的交叉熵损失。
