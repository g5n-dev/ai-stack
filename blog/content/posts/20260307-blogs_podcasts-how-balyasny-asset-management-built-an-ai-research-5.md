...
draft: false
entry_kind: "auto"
tags: ["LLM", "Agent", "工作流", "GPT", "投研", "金融", "模型评估", "RAG"]
categories: ["大模型", "AI 工程"]
source: blogs_podcasts
description: "以下是关于贝莱尼资产管理公司如何构建AI投资研究引擎的中文总结： **概述** 贝莱尼资产管理公司成功构建了一个基于人工智能（AI）的研究引擎。该系统利用先进的GPT-5.4模型、严格的模型评估流程以及智能体工作流，旨在从规模化层面彻底变革其投资分析流程。 **核心技术要素** 1. **先进的大语言模型 (GPT-5"
...
# 技术分析：Balyasny Asset Management 的 AI 投研系统架构
