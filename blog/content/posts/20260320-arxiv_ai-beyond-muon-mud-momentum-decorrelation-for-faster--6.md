...
draft: false
entry_kind: "auto"
tags: ["MUD优化器", "动量去相关", "Transformer训练", "极分解替代", "三角白化", "收敛性分析", "深度学习优化", "AdamW对比"]
categories: ["论文", "大模型"]
source: arxiv
description: "MUD：用于加速Transformer训练的动量去相关优化器 研究背景 当前流行的Muon等正交动量优化器通过极分解迭代来白化矩阵动量更新，能有效提升Transformer训练效果。然而，极分解近似通常需要多次大型矩阵乘法，导致显著的计算开销，且开销大小高度依赖硬件。 核心创新 本文提出MUD（MomentUm Dec"
