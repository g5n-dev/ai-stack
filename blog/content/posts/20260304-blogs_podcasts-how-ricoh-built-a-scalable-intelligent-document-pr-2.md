...
description: 以下是关于“理光如何在AWS上构建可扩展的智能文档处理（IDP）解决方案”的中文总结： **核心目标** 理光致力于将其文档处理业务从高度依赖**定制化工程**（导致效率瓶颈）的模式，转型为一个**可扩展、可复用的标准化服务**。
  **解决方案：构建标准化多租户系统** 理光利用 **AWS GenAI IDP Acc
