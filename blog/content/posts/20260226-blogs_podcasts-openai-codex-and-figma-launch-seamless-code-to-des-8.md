...
description: "OpenAI 与 Figma 宣布推出一项基于 Codex 的新集成功能，旨在打通代码与设计之间的壁垒。通过这一无缝衔接的体验，团队能够在代码实现与 Figma 设计画布之间自由切换，从而加速迭代流程并提升产品发布效率。"
...
**如何应用到自己的项目**
1.  **插件试用**：立即在Figma社区搜索并安装相关插件（如"CodeGen"或官方集成插件），尝试用自然语言生成基础组件。
2.  **Prompt库建立**：团队内部收集高效的Prompt指令，形成标准库。
...
**实践中的注意事项**
不要过度依赖AI生成复杂的逻辑。在处理关键的用户数据路径或安全性极高的功能时，必须由专业工程师人工复核代码。
