...
description: 以下是该内容的中文简洁总结： **亚马逊 Bedrock 推理任务运营可见性更新** 亚马逊宣布为 Amazon Bedrock 推出两项新的
  Amazon CloudWatch 指标：**TimeToFirstToken（首字生成时间）** 和 **EstimatedTPMQuotaUsage（预估
  TPM 配额使用
