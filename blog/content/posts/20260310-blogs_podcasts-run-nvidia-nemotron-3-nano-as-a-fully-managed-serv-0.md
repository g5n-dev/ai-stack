...
description: 以下是内容的中文总结： **亚马逊 Bedrock 新增托管 NVIDIA Nemotron 3 Nano 模型** 亚马逊宣布 **NVIDIA
  Nemotron 3 Nano** 模型现已正式上线 **Amazon Bedrock**，作为一种完全托管的无服务器（Serverless）模型提供服务。此前在
  AWS
