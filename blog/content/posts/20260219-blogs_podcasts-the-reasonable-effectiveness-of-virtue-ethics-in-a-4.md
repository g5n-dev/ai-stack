...
description: 前言 本文主张，理性的人没有目标，理性的AI也不应该有目标。人的行动之所以是理性的，并不是因为我们把行动指向某种终极的“目标”，而是因为我们把行动与实践1相协调：即行动的网络、行动倾向、行动评价标准，
  长期以来，主流观点常将理性视为对特定目标的优化，但本文提出了一个根本性的反思：理性的主体不应被单一的目标所定义，而应体现为行动与实践之间的协调。
