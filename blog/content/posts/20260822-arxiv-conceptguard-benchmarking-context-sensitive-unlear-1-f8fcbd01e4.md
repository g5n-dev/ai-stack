...
first_seen_at: 2026-08-22T05:41:58.372405Z
...
interpretation_sha256: "sha256:7082aa7ef6f1cd2f5c2faa675504bef51acc5c78471196f9d9998578ba5968ac"
description: "ConceptGuard 是一个用于评估大语言模型在上下文敏感场景下进行选择性遗忘的基准。它以“双用概念”为核心，构建互补的遗忘和保留集合，检验模型在消除有害使用的同时保持正当使用的效果。"
external_url: http://arxiv.org/abs/2608.20338v1
parent_observation_id: null
last_seen_at: 2026-08-22T05:41:58.372405Z
---
...
### 这是什么
ConceptGuard 是一个用于评估大语言模型在上下文敏感场景下进行选择性遗忘的基准。它以“双用概念”为核心，构建互补的遗忘和保留集合，检验模型在消除有害使用的同时保持正当使用的效果。

### 用在哪里
适合安全研究团队和模型开发者使用，帮助他们衡量新提出的遗忘方法在概念层面的上下文分离能力，以及对实际安全需求的契合度。

### 可以推断的
推测：该基准可能通过构造针对同一概念的对立提示，分别测试模型在有害和良性情境下的输出，以判断遗忘是否成功。  
推测：评估时可能不只依赖文本相似度指标，还会引入意图敏感的人工或自动判断，以捕捉模型在细分场景中的行为差异。
