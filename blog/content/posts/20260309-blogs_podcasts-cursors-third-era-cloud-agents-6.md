...
description: 以下是内容的简洁总结： $50B Agent Lab 宣布软件开发进入“第三时代”。 该机构在收购了 Graphite 和 Autotab
  之后，正式宣布其旗下的 Cloud Agents（云端智能体）业务已全面超越基于“VSCode 分支”的传统 IDE（集成开发环境）使用场景，成为核心发展方向。这标志着软件开发领域
