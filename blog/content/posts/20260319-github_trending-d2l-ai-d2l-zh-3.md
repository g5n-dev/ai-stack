...
description: d2l-ai/d2l-zh 仓库总结 基本信息 **仓库名称**：d2l-ai/d2l-zh（动手学深度学习中文版） **编程语言**：Python
  **星标数**：76,313（截至目前，仍在增长） 项目概述 d2l-zh 是《动手学深度学习》（Dive into Deep Learning，简称D2L）的中文版开源
