...
- 大模型
source: arxiv
description: 本文提出了一种通过**神经机制稀疏化**来高效发现近似因果抽象的新方法，旨在解决现有方法在验证神经网络可解释性时面临的计算瓶颈。 **核心问题与背景：**
  神经网络被认为执行了可解释的因果机制，但要验证这一点，通常需要找到一种“因果抽象”——即一种能在干预下忠实反映网络行为的高级结构因果模型（SCM）。然而，现有的发现
