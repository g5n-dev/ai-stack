...
- AI 工程
source: juejin
description: AI 编程工具在生成功能代码上表现突出，却在工程实践层面缺乏系统化的成熟度，难以满足 Google 级工程规范的要求。本篇文章通过 Agent
  Skills 评测，检验其在测试覆盖、代码审查、依赖管理和安全审计等方面的实际能力，并给出改进建议。对希望将 AI 工具融入正规开发流程的团队而言，了解这些指标有助于挑选更可靠的解决方案。
