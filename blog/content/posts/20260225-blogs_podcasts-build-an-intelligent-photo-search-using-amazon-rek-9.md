...
description: 本文介绍了如何利用 AWS 云开发工具包（AWS CDK），集成三项核心 AWS 服务——**Amazon Rekognition**、**Amazon
  Neptune** 和 **Amazon Bedrock**，来构建一个智能化的照片搜索系统。 核心功能与架构 该系统旨在超越传统的基于关键词或元数据的搜索，能够根据
