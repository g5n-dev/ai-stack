...
description: '**Gemini 推出音乐创作新功能：基于 Lyria 3 模型，支持文图生成 30 秒音乐** 近日，Gemini 应用宣布上线全新音乐创作功能，引入其最先进的音乐生成模型
  Lyria 3，为用户提供一种全新的自我表达方式。通过该功能，用户无需专业音乐背景，仅凭文本描述或图片输入，即可快速创作 30 秒原创音乐片段，'
