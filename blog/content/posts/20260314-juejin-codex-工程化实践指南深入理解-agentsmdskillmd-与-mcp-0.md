...
- 开发工具
source: juejin
description: 在构建 Codex 应用时，AGENTS.md、SKILL.md 与 MCP（Model Context Protocol）构成了核心工程骨架。理解这三者的协作机制，是将大语言模型从简单的对话工具转化为具备复杂工程能力的“AI
  工程师”的关键。本文将深入解析这三个概念的技术细节与交互逻辑，帮助开发者理清架构思路，从而更高效地搭建稳健的 AI 工程化体系。 以下是对该内容的简洁总结…
