...
description: '**Anthropic 发布 Claude Sonnet 4.6：稳健升级，优点与注意事项并存** Anthropic 再次赢得业界赞誉，推出了
  **Claude Sonnet 4.6**。此次更新被视为 4.5 版本的“稳健升级”，旨在提升模型的整体性能与实用性。以下是新模型的核心亮点及需要注意的细节：
  **核心优势'
