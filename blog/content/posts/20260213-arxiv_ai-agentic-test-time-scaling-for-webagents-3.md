...
- AI 工程
source: arxiv
description: 本文针对网页智能体在多步骤任务中面临的计算效率与可靠性挑战，提出了一种名为 CATTS 的置信度感知测试时扩展技术。该方法通过动态分配计算资源，试图在保证性能的同时优化推理过程。虽然摘要未详细披露具体的置信度评估机制，无法从摘要确认其在极端复杂场景下的鲁棒性，但该工作为提升智能体的实时决策能力提供了新的优化思路。
