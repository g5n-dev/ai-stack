...
- 论文
source: arxiv
description: 本文探讨了离网光伏系统中太阳辐照度预测面临的热力学约束问题。研究提出热力学流形网络方法，通过将气象与几何变量投影至Koopman线性化的黎曼流形，并构建谱标定单元与热力学α门，实现大气透射率与晴空模型的实时耦合。该方法在预测精度与计算效率上的具体表现尚需进一步验证。若能达到预期效果，有望为偏远地区微电网的能量管理提供可靠决策依据。
