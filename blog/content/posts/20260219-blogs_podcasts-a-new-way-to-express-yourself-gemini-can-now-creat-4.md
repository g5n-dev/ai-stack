...
draft: false
entry_kind: "auto"
tags: ["Gemini", "Lyria 3", "音乐生成", "文生音乐", "AI创作", "多模态", "Google", "AIGC"]
categories: ["大模型", "产品与创业"]
source: blogs_podcasts
description: "Gemini 推出了一项全新的自我表达方式：音乐生成功能。该应用集成了我们最先进的音乐生成模型 Lyria 3，能够支持用户通过文字或图片轻松创作 30 秒的音轨，让所有人都能实现音乐创作的愿望。"
...
**如何应用到自己的项目**
如果您是内容创作者，可以尝试用Gemina为您的视频素材生成BGM，测试其情感匹配度。如果您是开发者，可以关注Gemina API，探索将音乐生成集成到您的App中（如冥想App、社交App）。
...
**实践中的注意事项**
始终检查生成内容的合规性，并在发布时标记为AI生成，以维持透明度。
