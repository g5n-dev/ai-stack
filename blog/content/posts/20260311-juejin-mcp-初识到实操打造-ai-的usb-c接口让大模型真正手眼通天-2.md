...
draft: false
entry_kind: "auto"
tags: ["MCP", "Model Context Protocol", "LLM", "大模型", "协议标准", "Claude", "数据连接", "AI 接口"]
categories: ["AI 工程", "开发工具"]
source: juejin
description: "以下是关于 **MCP (Model Context Protocol)** 的简洁总结： 核心概念：AI 的“USB-C”接口 **MCP (Model Context Protocol)** 是一个开源的通用标准协议，旨在解决大语言模型（LLM）连接外部数据源时的“碎片化”问题。它被形象地称为 **AI 的“USB"
