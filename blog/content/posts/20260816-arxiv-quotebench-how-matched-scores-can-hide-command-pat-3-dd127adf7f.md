...
first_seen_at: 2026-08-16T05:42:17.397165Z
...
interpretation_sha256: "sha256:6d6e2eeaeeda4e2356054298256bf160e38247811482d26f46236f3bd646d9d7"
description: "QuoteBench 是一个评估框架，旨在区分大语言模型在生成 Bash 命令后因执行传输导致的错误与模型自身的生成错误，并通过最终状态验证来量化这类差异。"
external_url: http://arxiv.org/abs/2608.13547v1
parent_observation_id: null
last_seen_at: 2026-08-16T05:42:17.397165Z
---
...
### 这是什么  
QuoteBench 是一个评估框架，旨在区分大语言模型在生成 Bash 命令后因执行传输导致的错误与模型自身的生成错误，并通过最终状态验证来量化这类差异。  

### 用在哪里  
适用于评估代码生成式 AI 代理可靠性的研究团队，以及需要在命令行交互场景中保证安全部署的工程师。  

### 可以推断的  
推测：仅凭匹配分数评估模型可能导致对真实生成缺陷的低估。  
推测：在报告评估结果时明确说明执行路径和验证方式，有助于避免将传输过程中的问题误归因于模型本身。
