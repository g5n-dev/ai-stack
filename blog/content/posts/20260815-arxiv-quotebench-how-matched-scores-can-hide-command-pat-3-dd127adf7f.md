...
first_seen_at: 2026-08-14T16:06:20.356465Z
...
interpretation_sha256: "sha256:c0cce48ce076d6484c0ad576ae814a4dc92282e0fe2123aabbf59b6773291be1"
description: "该基准通过精确的最终状态验证，衡量大模型生成的命令行指令在生成后经解析、传输时引入的故障与模型本身错误的差异。"
external_url: http://arxiv.org/abs/2608.13547v1
parent_observation_id: null
last_seen_at: 2026-08-14T16:06:20.356465Z
---
...
### 这是什么
该基准通过精确的最终状态验证，衡量大模型生成的命令行指令在生成后经解析、传输时引入的故障与模型本身错误的差异。

### 用在哪里
适用于评估代码生成代理在命令行交互场景中的可靠性，也供系统设计者选择合适的解析与传输层时参考。

### 可以推断的
推测：在实际部署中，如果执行路径未对模型输出进行正确的转义处理，可能导致本应成功的命令被误判为失败。  
推测：提供解析边界的明确信息后，模型能够调整生成策略，从而在不同配置下恢复部分成功率。
