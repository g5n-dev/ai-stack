...
- 系统与基础设施
source: arxiv
description: 以下是对该内容的中文总结： 本文综述了**对比持续学习**在物联网领域的应用，旨在解决物联网设备在非平稳、动态环境中（如传感器漂移、用户行为变化及隐私需求差异）面临的模型适应性问题。
  核心内容总结如下： 1. **背景与方法**：持续学习（CL）通过适应模型来防止灾难性遗忘，而对比学习能以自监督方式提升鲁棒性和样本效率
