...
description: 以下是对该内容的中文总结： 本文主要介绍了如何在印度的 Amazon Bedrock 平台上使用“全球跨区域推理”功能来访问 Anthropic
  的 Claude 模型。 主要内容涵盖： 1. **核心功能**：利用 Amazon Bedrock 的全球跨区域推理能力，在印度区域访问和使用 Claude
  模型。 2.
