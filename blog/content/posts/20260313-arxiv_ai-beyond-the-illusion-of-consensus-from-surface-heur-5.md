...
draft: false
entry_kind: "auto"
tags: ["LLM评测", "LLM-as-a-Judge", "评估幻觉", "MERG", "RLAIF", "知识驱动", "一致性", "奖励模型"]
categories: ["大模型", "论文"]
source: arxiv
description: "**论文总结：《超越共识的幻觉：从表面启发式到基于知识的LLM评估》** **核心观点** 本研究挑战了“LLM-as-a-judge（LLM作为评判者）”范式的关键假设，即“高评估者一致性等于可靠且客观的评估”。论文通过大规模实验揭示了现有评估机制中的“评估幻觉”，并提出了基于知识的改进框架MERG。 **主要发现*"
