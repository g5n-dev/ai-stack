...
description: 本文介绍了如何利用 AWS 云开发 kit (AWS CDK) 构建一个智能照片搜索系统。该系统集成了三项核心 AWS 服务，实现了从图像分析到关系存储，再到智能理解的完整流程。
  **核心功能与服务集成：** 1. **Amazon Rekognition（图像分析）：** 作为系统的“视觉”前端，负责对上传的照片进行
