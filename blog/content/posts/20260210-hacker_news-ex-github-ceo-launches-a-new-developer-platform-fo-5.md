...
### 问题**: 阅读关于该新平台的文章，列出其支持的前三种编程语言或主要技术栈。如果文章未明确提及，请根据 GitHub 历史背景和当前 AI 开发趋势，推断该平台最可能优先集成的语言环境，并说明理由。

### 提示**: 关注文章中关于“工具链”、“集成”或“原生支持”的描述。如果需要推断，思考目前 AI 模型训练和推理最流行的社区是使用哪种语言的。
