...
- 安全
source: hacker_news
description: Google 推出的 NotebookLM 凭借其“音频概览”功能引发了广泛关注，该功能利用 AI 生成逼真的双人对话来总结文档。然而，前
  NPR 主持人 David Greene 指出，该工具生成的声音与他高度相似，引发了关于 AI 是否在未经同意的情况下克隆了其声音的争议。本文将梳理这一事件的来龙去脉，并探讨在
  AI 技术快速迭代的背景下，如何在提升工具实用性与保护个人声音权益之间找到平衡。
