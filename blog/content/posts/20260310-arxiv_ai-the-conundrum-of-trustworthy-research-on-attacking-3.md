...
- 数据
source: arxiv
description: 以下是针对该内容的中文总结： **关于个人身份信息移除技术攻击研究可信度的困境** **背景：** 从文本中移除个人身份信息（PII）对于遵守数据保护法规及实现隐私安全的数据共享至关重要。
  **问题：** 近期研究表明，经过PII移除技术处理的文档容易受到重构攻击。然而，作者认为这些报告中的攻击成功率被**严重高估**
