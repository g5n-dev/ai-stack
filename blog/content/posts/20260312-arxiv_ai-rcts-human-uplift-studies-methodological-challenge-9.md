...
- 数据
source: arxiv
description: 本文探讨了利用随机对照试验（RCTs）评估前沿 AI 系统的方法论挑战，旨在通过“人类赋能研究”衡量 AI 对人类绩效的影响。作者基于对
  16 位专家的访谈，总结了此类实验在实践中的具体障碍并提出应对方案。虽然摘要未详述具体的解决方案细节，但该工作为建立更严谨的 AI 评估标准提供了实证基础，有助于推动以人为中心的
  AI 安全研究。
