...
description: 从 Palantir 和 Two Sigma 到将 Goodfire 打造为可落地机械可解释性的标杆，Mark Bissell（技术团队成员）与
  Myra Deng（产品负责人）正通过发布 API、落地真实的企业级部署，将“窥视模型内部”转化为可复现的生产工作流；如今他们还通过近期……加大了这场赌注的规模。
  将“黑盒”模型转化为可解释的生产级工作流，已成为 AI 工程化的关键挑战。
