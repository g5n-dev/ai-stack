...
description: "以下是针对所提供内容的中文总结： OpenAI 引入了一种名为 **CoT-Control（思维链控制）** 的评估方法，旨在测试推理模型是否有能力控制自身的思考过程。相关实验发现，现有的推理模型在遵循指令停止或修改其思维链方面表现吃力。 这一发现具有积极意义，因为它强化了**“可监控性”**（Monitorabili"
