...
- 论文
source: juejin
description: 随着大模型应用向智能体演进，开发者习惯通过预设“技能”来增强其能力，但最新研究显示，许多精心设计的技能在实际任务中可能毫无作用，甚至成为干扰项。本文将基于《SkillsBench》论文的核心发现，解析为何通用技能往往难以适配具体场景，并探讨如何通过更严谨的基准测试来评估和优化技能有效性，帮助读者在构建
  Agent 时避免无效配置，真正提升系统性能。
