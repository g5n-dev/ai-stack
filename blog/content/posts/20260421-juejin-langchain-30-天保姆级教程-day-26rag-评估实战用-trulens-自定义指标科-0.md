...
- AI 工程
source: juejin
description: 在部署检索增强生成（RAG）系统后，仅凭主观感受或用户未投诉来判断答案质量，往往隐藏幻觉和关键信息遗漏的风险。本文将通过 TruLens
  框架演示如何构建自定义评估指标，提供可量化的召回率、准确率和答案一致性检测方法，并给出完整的代码示例，帮助你在实际项目中实现科学、系统的答案质量评估。
