...
description: 亚马逊宣布通过 Amazon Bedrock 全球跨区域推理功能，首次向中东地区（阿联酋和巴林）的客户提供 Anthropic 的 Claude
  系列模型，包括 Opus 4.6、Sonnet 4.6、Opus 4.5、Sonnet 4.5 和 Haiku 4.5。此功能不仅提升了系统的弹性，还允许用户直接访问先进的大
