...
- 论文
source: arxiv
description: 随着大语言模型向隐私敏感与个性化场景延伸，长上下文对模型能力的具体影响成为关键问题。该研究通过隐私与个性化视角揭示了模型在长文本处理中的扩展性缺陷，并提出了相应的评估框架。尽管其在模型架构层面的具体改进方案无法从摘要确认，但该工作为理解长上下文下的性能权衡提供了实证依据，有助于未来在兼顾隐私安全的前提下优化个性化生成策略。
