...
- 论文
source: arxiv
description: 以下是该内容的中文总结： **标题：长上下文，注意力分散——LLM在隐私与个性化领域的扩展鸿沟** **研究背景与问题** 随着大语言模型（LLM）越来越多地应用于隐私敏感和个性化定制场景，上下文长度（Context
  Length）的增加对“个性化效果”和“隐私保护”的具体影响仍是一个未被充分探索的领域。本文旨在揭示随
