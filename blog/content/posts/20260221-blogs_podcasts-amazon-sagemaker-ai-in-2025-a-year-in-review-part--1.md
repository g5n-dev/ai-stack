...
description: '**2025年 Amazon SageMaker AI 年度回顾（第一部分）总结** **核心摘要** 2025年，Amazon SageMaker
  AI 在核心基础设施层面取得了显著进展，主要围绕**容量、性价比、可观测性和易用性**这四个维度进行了全面升级。 本文作为回顾系列的第一部分，重点介绍了以下两个方面的关键'
