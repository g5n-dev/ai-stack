...
description: 以下是对该内容的中文总结： **标题：2025年 Amazon SageMaker AI 年度回顾（第一部分）：灵活的训练计划与推理工作负载性价比提升**
  **核心概述：** 2025年，Amazon SageMaker AI 在基础设施方面取得了显著进展，主要体现在**容量、性价比、可观测性和易用性**四个核心维度。
