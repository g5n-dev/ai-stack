...
- 论文
source: arxiv
description: 以下是对该内容的简洁总结： 本文介绍了一种名为 Anagent 的多智能体框架，旨在提升对科学图表的分析能力。 背景与挑战： 科学研究中的分析工作要求准确解读复杂的多模态知识并整合证据，但目前的
  AI 系统在面对结构复杂且多变的科学图表，以及长上下文需求时，往往面临巨大挑战。 核心贡献： 基准测试 (AnaBench)： 为了量化这些挑战，作者构建了一个大规模基准测试
  AnaBench。
