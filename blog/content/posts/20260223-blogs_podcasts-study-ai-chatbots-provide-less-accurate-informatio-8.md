...
draft: false
entry_kind: "auto"
tags: ["MIT", "LLM", "偏见", "准确性", "用户体验", "社会公平", "非英语用户", "低学历"]
categories: ["大模型", "论文"]
source: blogs_podcasts
description: "**总结：研究显示AI聊天机器人向弱势用户提供的信息准确性较低** 根据麻省理工学院建设性交流中心（MIT Center for Constructive Communication）的研究，领先的AI模型在服务特定用户群体时表现较差。这些弱势用户群体包括： 1. 英语熟练度较低的用户 2. 受教育程度较低（非正规教育"
...
### 如何应用到自己的项目
1.  **审计现有模型：** 收集公司内部历史记录中那些“失败”的对话（用户满意度低或重复提问的），分析这些用户的语言特征。
2.  **构建测试集：** 使用GPT-4等模型生成“低教育水平”或“非母语”风格的变体Prompt，测试你的AI系统。
