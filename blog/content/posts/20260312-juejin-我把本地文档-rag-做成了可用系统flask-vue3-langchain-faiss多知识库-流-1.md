...
draft: false
entry_kind: "auto"
tags: ["RAG", "LangChain", "Flask", "Vue3", "FAISS", "向量检索", "流式输出", "本地部署"]
categories: ["AI 工程", "后端"]
source: juejin
description: "这是一篇关于构建**本地化文档 RAG（检索增强生成）系统**的技术项目总结。 该项目针对现有 RAG 演示（Demo）通常缺乏实用性的痛点，构建了一套基于 **Flask + Vue3 + LangChain + FAISS** 的完整可用系统，并实现了**多知识库管理**与**流式输出**功能。 核心技术栈与架构"
