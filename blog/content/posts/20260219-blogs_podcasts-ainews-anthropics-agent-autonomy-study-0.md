...
description: 这一天平静无波，让我们得以深入探究 Anthropic 自己版本的 METR 数据。 在技术迭代趋于平缓的周期里，深入审视基准测试背后的原始数据，往往比追逐新功能更具参考价值。本文聚焦
  Anthropic 关于 Agent 自主性的内部研究，通过剖析其版本的 METR 数据，揭示了模型在真实任务中自主规划与执行的边界。
