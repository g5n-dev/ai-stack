...
- 论文
source: arxiv
description: 针对多智能体系统中个体因缺乏评估能力而盲目听从误导性同伴的脆弱性问题，本文提出了认识上下文学习（ECL）框架。该方法引入历史感知参考与显式画像构建，使智能体能够基于交互历史而非直接推理质量来建立信任。实验显示，应用ECL的小模型通过准确识别可靠同伴，其表现超越了体积数倍的基线大模型。不过，摘要未详细说明该框架在复杂动态环境下的具体计算开销，其泛化边界尚无法从摘要确认。
