...
draft: false
entry_kind: "auto"
tags: ["LangChain", "RAG", "LLM", "文本分割", "Splitter", "向量检索", "Embedding", "上下文窗口"]
categories: ["AI 工程", "大模型"]
source: juejin
description: "**Splitter学习笔记总结** 本文是对LangChain中**Splitter（文本分割器）**的学习笔记，结合RAG（检索增强生成）流程，系统梳理了其核心概念、工作原理、参数配置及代码实践。 **1. 核心概念与必要性** 大语言模型（LLM）无法一次性处理无限长的文本，且上下文窗口受限。因此，将长文档切分为"
...
### 3: 在代码实践中，如何设置 `chunk_size` 和 `chunk_overlap` 这两个核心参数？
