...
- 开源生态
source: juejin
description: 由于提供的文本中断，以下仅基于现有信息进行简要总结： **小米开源具身智能VLA模型Xiaomi-Robotics-0** **核心概况：**
  2026年2月12日，小米正式开源其首代机器人视觉-语言-动作（VLA）大模型——**Xiaomi-Robotics-0**。该模型的发布标志着具身智能领域的重要技术突破，旨在
