...
description: 随着 OpenAI 发布 CoT-Control 技术，关于如何监控大模型思维链的讨论再次成为焦点。研究发现，推理模型往往难以完全自主地控制其思考过程，这一局限性反而凸显了外部监控机制在保障
  AI 安全中的关键作用。本文将深入解析这一技术背后的逻辑，探讨为何“难以控制”对于构建可信赖的 AI 系统而言，或许是一个积极信
