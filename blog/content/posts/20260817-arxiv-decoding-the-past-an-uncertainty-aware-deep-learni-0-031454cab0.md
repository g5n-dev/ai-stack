...
first_seen_at: 2026-08-17T10:48:16.691092Z
...
interpretation_sha256: "sha256:4633922cfb5245a5fa7708d9b3f315aefe42a87602fdd2742d2c723acc359408"
description: "这是一篇利用不确定性感知深度学习框架，对旧石器时代手印岩刻进行性别推断的研究。"
external_url: http://arxiv.org/abs/2608.14539v1
parent_observation_id: null
last_seen_at: 2026-08-17T10:48:16.691092Z
---
...
### 这是什么  
这是一篇利用不确定性感知深度学习框架，对旧石器时代手印岩刻进行性别推断的研究。

### 用在哪里  
适用于考古学家、岩石艺术研究者以及对古代人类行为感兴趣的研究团队，尤其是面对缺乏直接标签、需要评估岩刻创作者性别的情况。

### 可以推断的  
- 推测：该框架通过生成多个轮廓实现并结合集成模型，能够帮助区分形态稳定与模糊的手印，从而提升考古推断的可靠性。  
- 推测：在缺乏真实标签的情形下，系统提供的置信度信息可以协助研究者判断哪些案例值得进一步人工审查。
