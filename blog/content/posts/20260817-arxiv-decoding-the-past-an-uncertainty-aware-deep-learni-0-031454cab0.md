...
first_seen_at: 2026-08-17T11:40:06.129178Z
...
interpretation_sha256: "sha256:f1c11532d18aa629d1d609739d90fad95a422bf039c20ffb4d7a5261ef57af6d"
description: "该研究提出一种不确定性感知深度学习框架，旨在从旧石器时代手印模板推断制作者的性别，并通过量化内部一致性来评估预测的可信度。"
external_url: http://arxiv.org/abs/2608.14539v1
parent_observation_id: null
last_seen_at: 2026-08-17T11:40:06.129178Z
---
...
### 这是什么
该研究提出一种不确定性感知深度学习框架，旨在从旧石器时代手印模板推断制作者的性别，并通过量化内部一致性来评估预测的可信度。

### 用在哪里
适用于考古学家、古人类学者，在缺乏真实标签或图像退化严重的史前手印研究中进行性别归因，并提供可信度评估。

### 可以推断的
- 推测：当多个模型及潜在空间映射在性别预测上呈现一致时，对应样本的性别属性可能更可靠。  
- 推测：对图像边缘模糊或受损严重的模板，系统可能输出较低的置信度，以提示用户谨慎解读。
