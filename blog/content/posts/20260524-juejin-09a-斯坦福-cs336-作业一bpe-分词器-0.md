...
- 论文
source: juejin
description: CS336 课程第一份作业要求实现 BPE（Byte Pair Encoding）分词器，这一任务直接涉及自然语言处理中常见的子词切分技术。完成该实现能够帮助理解文本从字符到词块的映射过程，并掌握基于频率的合并规则如何生成词汇表。通过本作业，读者可以一步步调试代码、对比不同合并顺序对分词效果的影响，从而在实际项目中更好地选择和调优分词策略。
