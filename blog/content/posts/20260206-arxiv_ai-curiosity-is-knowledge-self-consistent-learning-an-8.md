...
- 论文
source: arxiv
description: 针对主动推理中探索与利用的平衡难题，本文首次为基于期望自由能最小化的智能体建立了理论保证，证明了只要满足“足够的好奇心”这一条件，即可同时确保自一致的学习与无后悔的优化。该分析通过引入初始不确定性等变量，将主动推理与经典贝叶斯实验设计统一在同一框架下。研究进一步提供了调节认知与实用权衡的设计指南，但其在高维复杂任务中的具体泛化性能尚无法从摘要确认。
