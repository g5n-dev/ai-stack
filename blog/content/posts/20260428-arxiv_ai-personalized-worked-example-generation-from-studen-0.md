...
- AI 工程
source: arxiv
description: 在编程教育中，为学生提供个性化的学习示例一直是提升学习效果的重要手段。本研究提出从学生代码提交中自动生成个性化工作示例的方法，并采用基于模式的知识点进行知识建模。该方法的具体实现细节及在真实教学环境中的效果尚需进一步验证。若能有效应用，这一技术有望为智能辅导系统提供新的示例生成途径，支持编程课程的个性化学习设计。
