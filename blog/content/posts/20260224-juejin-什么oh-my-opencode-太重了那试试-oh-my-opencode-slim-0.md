...
draft: false
entry_kind: "auto"
tags: ["AI编程", "LLM", "Agent", "开源工具", "性能优化", "Token成本", "自动化", "开发效率"]
categories: ["AI 工程", "开发工具"]
source: juejin
description: "您提供的内容非常简短，以下是对其的总结： **oh-my-opencode-slim** 是 **oh-my-opencode** 的**精简版 AI 编程工具**。其主要特点如下： 1. **轻量高效**：体积比完整版缩小 **80%**，且 **Token 成本更低**。 2. **核心保留**：保留了核心的 **"
