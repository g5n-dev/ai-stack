...
draft: false
entry_kind: "auto"
tags: ["LangGraph", "AI Agent", "工作流", "状态管理", "有向图", "LangChain", "RAG", "多智能体"]
categories: ["AI 工程", "大模型"]
source: juejin
description: "以下是对 LangGraph 框架核心内容的中文总结： LangGraph 框架核心总结：构建生产级 AI 工作流 LangGraph 是一个专为构建**有状态**（Stateful）、**多参与者**（Multi-agent）的 AI 应用而设计的框架。它弥补了传统链式架构在处理复杂逻辑时的不足，是构建生产级 AI"
