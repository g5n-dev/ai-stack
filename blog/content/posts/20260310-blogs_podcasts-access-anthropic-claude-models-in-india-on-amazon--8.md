...
description: 本文介绍了如何通过 Amazon Bedrock 的**全球跨区域推理**功能，在印度访问和使用 Anthropic 的 Claude 模型。主要内容包括：
  1. **核心功能**：利用 Amazon Bedrock 的 Global cross-Region Inference，用户可以在印度区域直接调用 Claud
