...
first_seen_at: 2026-08-22T20:39:04.722714Z
...
interpretation_sha256: "sha256:e672cd45be8dad30cc3259485d56e3f1ea60036f25aeaa152dc9155bd12a798a"
description: "该工作提出了一个名为ConceptGuard的基准，用于在概念层面评估大语言模型的遗忘能力，旨在实现对双用途概念的有害使用进行抑制，同时保留其良性用途。"
external_url: http://arxiv.org/abs/2608.20338v1
parent_observation_id: null
last_seen_at: 2026-08-22T20:39:04.722714Z
---
...
### 这是什么
该工作提出了一个名为ConceptGuard的基准，用于在概念层面评估大语言模型的遗忘能力，旨在实现对双用途概念的有害使用进行抑制，同时保留其良性用途。

### 用在哪里
适用于LLM安全研究者和模型开发者，用于比较不同遗忘方法在概念层面控制风险的能力，也可为安全评估机构提供参考。

### 可以推断的
推测：构建该基准需要对双用途概念进行系统划分，并标注对应的无害与有害情境。  
推测：现有遗忘技术在概念层面的分离度不足，可能难以满足实际部署中的安全需求。
