...
date: 2026-08-22T11:58:12+08:00
draft: false
entry_kind: "auto"
...
first_seen_at: 2026-08-22T03:56:13.041713Z
...
interpretation_sha256: "sha256:c76caf66ceae87430002a79b73b3d5365a70730a45a63a5e314d8b2189325256"
description: "这是一段访谈，Joon Sung Park（Simile AI 联合创始人）分享了从生成式代理（如 Smallville）到构建人类行为基础模型的技术路径，阐释了利用大规模仿真在真实决策前进行测试的思路。"
external_url: https://www.latent.space/p/simile
parent_observation_id: null
last_seen_at: 2026-08-22T03:56:13.041713Z
---
...
### 这是什么  
这是一段访谈，Joon Sung Park（Simile AI 联合创始人）分享了从生成式代理（如 Smallville）到构建人类行为基础模型的技术路径，阐释了利用大规模仿真在真实决策前进行测试的思路。  

### 用在哪里  
适合关注人工智能仿真、数字双胞胎、行为建模以及政策与产品快速验证的研究者、产品经理和政策制定者。  

### 可以推断的  
推测：高质量的仿真需要大量真实行为数据并通过实验不断校正模型偏差。  
推测：合成人群有望替代传统焦点小组，以更低成本提供可重复的反馈。
