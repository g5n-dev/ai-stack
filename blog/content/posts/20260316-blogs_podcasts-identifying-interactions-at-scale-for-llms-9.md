...
draft: false
entry_kind: "auto"
tags: ["LLM", "可解释性", "归因分析", "SPEX", "消融实验", "特征交互", "模型安全", "AI研究"]
categories: ["大模型", "论文"]
source: blogs_podcasts
description: "本文主要介绍了用于识别大型语言模型（LLMs）中关键交互行为的算法 **SPEX** 和 **ProxySPEX**。 **核心问题：** 理解和解释像LLMs这样的复杂机器学习系统是现代AI的关键挑战。为了构建更安全、可信赖的AI，研究人员通过**特征归因**、**数据归因**和**机制可解释性**等不同视角来分析模"
