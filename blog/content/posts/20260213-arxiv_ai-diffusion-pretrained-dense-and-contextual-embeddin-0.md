...
draft: false
entry_kind: "auto"
tags: ["Embeddings", "扩散模型", "RAG", "信息检索", "对比学习", "长文本", "双向注意力", "Perplexity"]
categories: ["大模型", "论文"]
source: arxiv
description: "本文介绍了 **pplx-embed**，这是一组专为网络级检索设计的多语言嵌入模型家族。该模型在基于扩散预训练的语言模型骨干网络上，采用了多阶段对比学习技术。 主要特点与成果如下： 1. **技术架构**：利用扩散预训练中的**双向注意力机制**，模型能够捕获篇章内全面的上下文信息。这允许模型采用平均池化和“延迟分块"
