...
description: 译文： 宁静的一天，让我们得以细细回味一篇出色的文章。 随着开源模型快速普及，模型研发实验室与专注于构建智能体的代理实验室之间的界限变得愈发清晰。萨拉·郭在本文中探讨了两类实验室的定位差异，并指出现阶段哪些能力仍是模型难以通过训练获得的。对想要把握AI技术走向、制定产品或研究方向的从业者而言，这篇分析提供了兼具深度与实操价值的视角。
