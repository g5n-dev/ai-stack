...
draft: false
entry_kind: "auto"
tags: ["LLM", "Agent", "MCP", "Tool Use", "Prompt Engineering", "AI 工程化", "知行合一", "Skill"]
categories: ["AI 工程", "大模型"]
source: juejin
description: "基于您提供的关键词和领域信息，这段内容的核心可以总结为： **“知行合一”的AI工程化：从大模型到智能体（Agent）的跨越** 这段内容探讨了人工智能（特别是大语言模型，LLM）如何从静态的“知识库”进化为具备行动力的“智能体”，核心在于**Skill（技能）**与**Tool Use（工具使用）**的结合。 **1"
...
**A**: 这种能力的实现主要依赖于深度学习中的**Transformer 架构**以及基于此的**预训练大语言模型（LLM）**。
