...
description: 本文介绍了如何在印度的 Amazon Bedrock 上利用全球跨区域推理功能访问 Anthropic 的 Claude 模型。 文章主要内容包括：
  1. **核心功能**：介绍了 Amazon Bedrock 的 Global cross-Region Inference 功能，使印度用户能够使用 Claude
  模型
