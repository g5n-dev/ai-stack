...
- 系统与基础设施
source: arxiv
description: 本文针对光学系统控制中高保真度与自主化的需求，提出了基于模型上下文协议（MCP）的 Agentic AI 框架 AgentOptics。该框架通过自然语言指令直接驱动异构光学设备的协议级操作，实现了对复杂光路的自动化调控。虽然摘要未详述具体鲁棒性指标，无法从摘要确认其在极端环境下的表现，但该研究为人机协作的光学实验自动化提供了新的技术路径。
