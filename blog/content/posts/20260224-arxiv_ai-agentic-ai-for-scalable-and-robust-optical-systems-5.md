...
draft: false
entry_kind: "auto"
tags: ["Agentic AI", "MCP", "光学控制", "AgentOptics", "多智能体", "系统鲁棒性", "工具抽象", "自然语言交互"]
categories: ["AI 工程", "系统与基础设施"]
source: arxiv
description: "本文介绍了 **AgentOptics**，一个基于**模型上下文协议（MCP）**构建的**智能体 AI（Agentic AI）框架**，旨在实现对光学系统的高保真、自主控制。该框架能够解读自然语言指令，并通过结构化的工具抽象层，对异构光学设备执行符合协议的操作。 **核心成果与评估：** 研究团队实现了跨 8 种代"
