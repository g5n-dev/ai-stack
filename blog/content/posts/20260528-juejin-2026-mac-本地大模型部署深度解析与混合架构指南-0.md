...
draft: false
entry_kind: "auto"
tags: ["本地部署", "Ollama", "MLX", "Apple Silicon", "混合架构", "推理优化", "端侧AI", "量化"]
categories: ["大模型", "AI 工程"]
source: juejin
description: "背景 Apple Silicon 已进入第六代，硬件算力足以在本地跑 70 B 参数的大模型。2026 年 Ollama 0.19 将推理后端迁移到 Apple 的 MLX 框架，实现 CPU+GPU 协同推理，使 Mac 设备在功耗、成本和隐私方面具备竞争力。 关键组件 - **MLX**：Apple 自研的张量库，"
