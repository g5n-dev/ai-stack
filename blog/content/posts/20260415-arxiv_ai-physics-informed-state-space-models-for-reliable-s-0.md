...
draft: false
entry_kind: "auto"
tags: ["太阳能预测", "物理信息模型", "状态空间模型", "离网光伏", "Koopman", "流形学习", "热力学约束", "可再生能源"]
categories: ["论文"]
source: arxiv
...
- [语言统计对称性塑造模型表征的几何结构]({{< relref "posts/20260218-arxiv_ai-symmetry-in-language-statistics-shapes-the-geometr-0.md" >}})
