...
draft: false
entry_kind: "auto"
tags: ["大模型微调", "灾难性遗忘", "SFT", "Amazon Nova", "模型训练", "LLM", "AI", "模型优化"]
categories: ["大模型", "AI 工程"]
source: juejin
description: "这是一段关于大模型微调中“灾难性遗忘”问题及 **Amazon Nova Forge** 解决方案的简要总结： **核心问题：灾难性遗忘** 在微调大模型时，开发者常面临一个两难的局面：虽然模型经过监督微调（SFT）后在新领域（如特定行业知识）的能力变强了，但却出现了“遗忘”现象，导致原有的通用能力（如写文章、逻辑推理"
