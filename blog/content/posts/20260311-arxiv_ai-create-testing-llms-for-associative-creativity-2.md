...
- 论文
source: arxiv
description: 本文介绍了 **CREATE**，一个旨在评估大语言模型（LLM）**联想创造力**的新基准测试。 创造力核心在于“联想推理”，即在不同概念间建立新颖且有意义的联系的能力。CREATE
  要求模型基于其内部知识，生成连接两个概念的路径。评分标准侧重于路径的**特异性**（连接的独特性和紧密性）以及**多样性**（路径间的
