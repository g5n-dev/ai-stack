...
draft: false
entry_kind: "auto"
tags: ["Gemini", "Lyria 3", "音乐生成", "多模态", "AIGC", "Google", "图文生成", "AI创作"]
categories: ["大模型", "产品与创业"]
source: blogs_podcasts
description: "Gemini 现在推出了一项全新的自我表达功能。应用内已集成我们目前最先进的音乐生成模型 Lyria 3，赋能任何用户仅通过输入文本或上传图片，即可轻松创作出 30 秒的音频曲目。"
...
**实践中的注意事项**
不要完全依赖 AI 生成最终成品。AI 生成的音乐往往缺乏人类演奏的细微“表情”或动态起伏，建议作为灵感原型或背景底座，人工进行微调或混音。
