...
draft: false
entry_kind: "auto"
tags: ["CoT", "模型推理", "思维链", "Reasoning Theater", "模型信念", "LLM", "实证分析", "模型解耦"]
categories: ["大模型", "论文"]
source: arxiv
description: "本文针对推理模型中的**“推理剧场”**（即模型在思维链中生成冗余内容而非反映真实信念的现象）进行了实证分析。 **核心发现：** 1. **信念与表现分离：** 模型在生成思维链时，其内部信念往往已确定，但仍会继续生成并未反映真实信念的Token。这表现为模型对最终答案极具信心，却仍在“表演”推理过程。 2. **任"
