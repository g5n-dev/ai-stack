...
description: 本文主要介绍了 **P-EAGLE**，这是一种集成于 **vLLM**（从 v0.16.0 版本开始）以加速大语言模型（LLM）推理的技术。以下是内容的要点总结：
  **1. 什么是 P-EAGLE？** P-EAGLE 是 **EAGLE（Extrapolation Algorithm for Greater Lan
