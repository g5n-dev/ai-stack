...
- 论文
source: arxiv
description: 针对日益强大的 GUI 智能代理已能攻破传统验证码的安全现状，本文提出了 Next-Gen CAPTCHAs 框架，旨在利用人类与 AI
  在交互感知与决策上的“认知差距”重建防御壁垒。该方案通过动态任务生成机制，不仅实现了近乎无限的验证码实例扩展，还强调了适应性直觉在区分生物用户与 AI 中的核心作用。
