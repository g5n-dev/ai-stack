...
description: '**简述：** [AINews] 报道，AI领域经历平静一日后，业界聚焦 Anthropic 推迟开放 100 万 token 上下文窗口（context
  window）的通用版本，而竞品 Gemini 和 OpenAI 已率先实现类似功能。这一延迟引发对 Anthropic 技术进展节奏的讨论。'
