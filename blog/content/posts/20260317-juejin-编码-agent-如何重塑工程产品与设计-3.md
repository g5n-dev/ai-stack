...
draft: false
entry_kind: "auto"
tags: ["编码Agent", "LangChain", "工作流", "软件工程", "AI辅助开发", "Harrison Chase", "EPD", "自动化"]
categories: ["大模型", "产品与创业"]
source: juejin
description: "随着 LangChain 联合创始人 Harrison Chase 对编码 Agent（Coding Agents）的深度剖析，我们得以窥见这一技术如何正在从根本上重塑软件公司的工程、产品与设计（EPD）协作模式。这种转变不仅关乎代码生成，更意味着工作流程与角色边界的重新定义。本文将系统梳理编码 Agent 对 EPD"
