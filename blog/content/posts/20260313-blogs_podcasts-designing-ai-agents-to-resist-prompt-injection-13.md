...
draft: false
entry_kind: "auto"
tags: ["AI Agent", "提示注入", "系统安全", "社会工程学", "权限控制", "数据隔离", "人机协同", "防御策略"]
categories: ["安全", "AI 工程"]
source: blogs_podcasts
description: "以下是对文中关于防御AI代理提示注入内容的中文总结： **设计能够抵御提示注入的AI代理** 本文主要探讨了如何通过设计安全的AI代理来防御**提示注入**和**社会工程学**攻击，重点介绍了ChatGPT在代理工作流中采取的安全策略。 **核心概念：提示注入与代理风险** 随着AI代理功能的增强，它们被赋予了执行操作"
...
### 如何应用到自己的项目
1.  **审查所有工具定义**：检查你的Function Calling或Tool定义中，是否有允许传递任意字符串到高风险接口（如Shell、SQL）的情况。
2.  **实施“人机回路”**：对于涉及金钱、邮件发送、数据删除的操作，强制要求人类审批。

### 具体的行动建议
- **代码审查清单**：增加一项“Prompt注入风险检查”。
- **测试集**：构建一组包含“越狱”、“角色扮演”、“指令覆盖”的测试用例，在上线前进行回归测试。

### 需要补充的知识
- **OWASP Top 10 for LLM**：了解大语言模型应用安全的十大风险。
- **网络安全基础**：特别是关于输入验证和沙箱逃逸的知识。
