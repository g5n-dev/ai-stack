...
draft: false
entry_kind: "auto"
tags: ["Qwen3.5", "MoE", "稀疏模型", "模型推理", "性能优化", "开源模型", "混合专家", "参数效率"]
categories: ["大模型", "开源生态"]
source: blogs_podcasts
description: "**Qwen3.5-397B-A17B：高效能的Open-Opus级最小模型** 近日，Qwen团队发布了新模型**Qwen3.5-397B-A17B**，引发了广泛关注。该模型的核心亮点在于其在保持高性能（Open-Opus级别）的同时，实现了极高的参数效率，是目前已知最小的Open-Opus级模型。 **主要特点："
