...
- 论文
source: arxiv
description: 本文提出了 COMIC 系统，旨在探索利用多智能体架构全自动生成类似《周六夜现场》的素描喜剧视频。该研究通过模拟真实制作工作室的分工协作，构建了基于角色的智能体协同流程，但具体的生成质量及细节无法从摘要确认。这一工作为自动化影视内容创作提供了新的技术路径，未来有望应用于辅助剧本开发或交互式娱乐等场景。
