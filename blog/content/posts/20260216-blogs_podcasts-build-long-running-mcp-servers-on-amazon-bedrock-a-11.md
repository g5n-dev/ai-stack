...
draft: false
entry_kind: "auto"
tags: ["Amazon Bedrock", "AgentCore", "MCP", "异步框架", "长时运行", "AI 代理", "Strands Agents", "上下文管理"]
categories: ["AI 工程", "后端"]
source: blogs_podcasts
description: "本文介绍了如何利用 Amazon Bedrock AgentCore 结合 Strands Agents 集成，构建能够处理长时间运行任务的 MCP（Model Context Protocol）服务器。为了实现这一目标，文章提出了一套综合性的解决方案，主要包含以下三个关键策略： 1. **上下文消息策略**： 针对长"
