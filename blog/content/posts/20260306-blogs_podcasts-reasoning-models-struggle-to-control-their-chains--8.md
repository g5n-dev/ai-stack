...
description: 这篇文章总结了关于OpenAI最新研究“CoT-Control”的核心观点及其对AI安全的意义，主要内容如下： **1. 核心发现：推理模型难以自我控制思维链**
  OpenAI引入了一项名为“CoT-Control”的技术，旨在测试大型推理模型是否能够按照指令精确控制其内部的推理过程（即“思维链”，Chain of T
