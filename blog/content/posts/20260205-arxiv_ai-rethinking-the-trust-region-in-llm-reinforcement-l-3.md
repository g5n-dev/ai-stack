...
- 论文
source: arxiv
description: 现有大型语言模型强化学习微调普遍采用 PPO 算法，但该文指出其核心的比率裁剪机制在应对 LLM 海量词表时存在结构性不匹配。为此，作者提出了一种重新定义信任域的方法，旨在修正概率比约束带来的更新偏差。尽管摘要未详述具体算法细节，但该工作为解决高维动作空间下的策略优化提供了新视角，有望提升模型对齐训练的稳定性。
