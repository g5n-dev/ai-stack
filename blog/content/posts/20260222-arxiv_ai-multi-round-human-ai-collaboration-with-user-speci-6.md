...
draft: false
entry_kind: "auto"
tags: ["人机协作", "多轮对话", "决策质量", "反事实危害", "互补性", "用户自定义", "AI行为规范", "cs.LG"]
categories: ["大模型", "论文"]
source: arxiv
description: "**总结：用户自定义需求下的多轮人机协作** 随着对话式AI在高风险决策场景中的应用日益广泛，如何确保多轮交互能可靠地提升决策质量成为关键挑战。本文提出了一种以用户为中心的人机协作框架，旨在通过两个核心原则——**反事实伤害**和**互补性**——来规范AI的行为，确保AI既能发挥优势又不削弱人类的能力。 **核心内容"
...
### 产业化可能性
该框架具有极高的产业化潜力，因为它解决了企业部署AI时的**合规性**和**可控性**痛点。它不需要重新训练底层大模型，而是作为一个“控制层”或“护栏”接入现有的AI系统。
