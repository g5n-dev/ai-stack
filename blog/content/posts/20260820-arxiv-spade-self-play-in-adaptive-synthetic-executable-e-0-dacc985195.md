...
first_seen_at: 2026-08-20T05:45:57.039714Z
...
interpretation_sha256: "sha256:3140567e41c8da363c6a66677e150bdd21be8f66928b05f4e4e5263d4ff2f69c"
description: "SPADE 让同一个大模型同时扮演“环境设计者”和“推理主体”。设计者用代码生成完整的长时序可执行环境（包含状态转移、奖励函数和验证逻辑），推理主体在这些环境中学习动作，并通过有/无提示奖励的差距估算regret，从而让设计者自动把环境推向能力边缘。"
external_url: http://arxiv.org/abs/2608.19197v1
parent_observation_id: null
last_seen_at: 2026-08-20T05:45:57.039714Z
---
...
### 这是什么
SPADE 让同一个大模型同时扮演“环境设计者”和“推理主体”。设计者用代码生成完整的长时序可执行环境（包含状态转移、奖励函数和验证逻辑），推理主体在这些环境中学习动作，并通过有/无提示奖励的差距估算regret，从而让设计者自动把环境推向能力边缘。

### 用在哪里
适用于需要持续提升语言智能体推理与工具使用能力的研发场景，如自适应训练任务生成、开放式评测以及多轮交互训练。关注自监督改进和动态环境的团队会比较感兴趣。

### 可以推断的
推测：在训练过程中加入对文档的记忆，可让生成的环境更具多样性和实用性。  
推测：随着模型规模增大，系统在游戏类任务上的表现提升幅度可能进一步扩大。
