...
draft: false
entry_kind: "auto"
tags: ["Claude Code", "LLM", "AI 编程", "GitHub", "HBM", "内存紧缺", "SemiAnalysis", "金融科技"]
categories: ["AI 工程", "开发工具"]
source: blogs_podcasts
description: "这段内容主要来自SemiAnalysis的Doug O'Laughlin，围绕**Claude Code发布一周年**及其在**金融领域的应用**，以及当前全球**内存（HBM）短缺**的局势进行了深入讨论。核心观点总结如下： **一、 Claude Code 与编程变革** 1. **颠覆性的影响**：作为Claud"
