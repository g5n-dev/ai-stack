...
- 论文
source: arxiv
description: 针对统一多模态大语言模型中视觉表示难以兼顾高保真重建与生成适用性的问题，本文提出了统一二进制 Tokenizer——UniWeTok。该方法利用
  $2^{128}$ 规模的码本及卷积-注意力混合架构，有效平衡了 Token 熵损失与承诺损失的优化冲突。实验表明，该模型在图像生成与编辑等任务上达到 SOTA
  性能且训练成本显著降低，但其对长视频流等极端高分辨率场景的适用性无法从摘要确认。
