...
- 大模型
source: juejin
description: MWC（世界移动通信大会）已成为中国AI的主场，小米等企业正推动AI从虚拟对话框走向物理世界的实际应用，标志着全球AI竞争从技术参数比拼转向应用落地的关键阶段。
  过去两年，AI竞争聚焦于模型规模和参数性能，而当前核心已转向“应用兑现”——谁能将AI技术融入真实场景、解决实际问题，谁就能占据优势。小米在MWC展示的实践正
