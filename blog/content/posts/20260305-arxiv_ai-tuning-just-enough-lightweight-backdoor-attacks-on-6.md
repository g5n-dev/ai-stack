...
- 大模型
source: arxiv
description: 以下是对该内容的中文总结： **标题：** 恰到好处的微调：针对多编码器扩散模型的轻量级后门攻击 **主要内容总结：** 随着文生图扩散模型在实际应用中的广泛部署，其后门安全问题日益受到关注。以往的研究主要集中在仅使用单一轻量级文本编码器的模型上，而忽略了像
  Stable Diffusion 3 这样集成了多个大规模文
