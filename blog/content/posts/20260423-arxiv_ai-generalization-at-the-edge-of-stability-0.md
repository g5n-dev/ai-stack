...
draft: false
entry_kind: "auto"
tags: ["边缘稳定", "泛化", "随机动力系统", "分形吸引子", "Lyapunov", "锐度维数", "Hessian", "混沌训练"]
categories: ["大模型", "论文"]
source: arxiv
description: "研究背景 大规模神经网络的训练常采用大学习率，逼近“边缘稳定”状态，此时优化轨迹呈振荡甚至混沌特征。经验表明，这种混沌 regime 能带来更好的泛化性能，但其背后的机理尚未得到理论解释。 方法与理论 1. **随机动力系统视角**：将随机优化器建模为随机动力系统，发现其常收敛到分形吸引子（而非单纯极点），且该吸引子具"
