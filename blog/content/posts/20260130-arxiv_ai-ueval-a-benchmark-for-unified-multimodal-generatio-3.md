...
- 论文
source: arxiv
description: '**UEval：统一多模态生成基准总结** UEval 是一个全新的基准测试，旨在评估“统一模型”的能力，即能够同时生成图像和文本的模型。其主要特点和发现如下：
  1. **数据集构成**： 包含 1,000 道由专家精心策划的题目，涵盖 8 种现实任务场景。这些题目要求模型输出必须同时包含图像和文本，且覆盖了从分步指南'
