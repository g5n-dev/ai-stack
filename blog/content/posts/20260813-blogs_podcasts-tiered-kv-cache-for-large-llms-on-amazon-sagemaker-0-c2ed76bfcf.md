...
revision_id: rev_94d304073e6e5eb9027ab5ef23ee74300c511ce9e8af5f0934ba07d2011b31d3
source_published_at: 2026-08-12T13:42:48Z
first_seen_at: 2026-08-13T17:12:10.616159Z
...
interpretation_sha256: "sha256:f0e8af472a86f4ac592acfa07a7f49c09d150ff621ff35400ceb1d0ca230deea"
...
### 这是什么
这是一种在大型语言模型推理时将 KV 缓存分层管理的方案，分别使用 GPU 显存、主机内存和共享的 NVMe 池，实现跨副本的缓存复用。

### 用在哪里
适用于在多业务线 endpoint、RAG 流程或多轮对话等高并发场景下部署多种基础模型，需要在内存受限实例上保持低 TTFT 的团队。

### 可以推断的
推测：通过在共享 NVMe 池中缓存 KV 块，可提升跨副本命中概率，从而缩短首次生成时间。  
推测：该三层结构能够在不增加高端实例规格的前提下，降低每个 endpoint 的成本。
