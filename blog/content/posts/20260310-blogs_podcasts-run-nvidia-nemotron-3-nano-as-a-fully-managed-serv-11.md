...
description: "**总结** 亚马逊宣布在 Amazon Bedrock 平台上正式推出 **NVIDIA Nemotron 3 Nano** 模型，并提供完全托管的**无服务器**服务。 此前，AWS 已在 re:Invent 大会上支持了 Nemotron 2 Nano 9B 和 Nemotron 2 Nano VL 12B 模型"
...
**实际应用建议**
建议企业将Nemotron 3 Nano作为RAG流程中的“重排序”模型或
