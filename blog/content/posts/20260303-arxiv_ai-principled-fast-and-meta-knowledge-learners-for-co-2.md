...
draft: false
entry_kind: "auto"
tags: ["强化学习", "持续学习", "元学习", "灾难性遗忘", "知识迁移", "双学习器", "cs.LG", "GitHub"]
categories: ["论文", "大模型"]
source: arxiv
description: "以下是该内容的中文总结： **研究背景与动机** 本研究受人类学习与记忆系统（特别是海马体与大脑皮层相互作用）的启发，旨在解决连续强化学习中的问题。 **核心方法** 研究提出了一种**双学习器框架**，包含两个互补的组件： 1. **快速学习器**：专注于**知识迁移**，利用过去的知识快速适应新任务。 2. **元"
