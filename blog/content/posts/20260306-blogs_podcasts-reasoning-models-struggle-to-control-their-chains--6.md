...
description: 以下是内容的中文总结： **核心观点：推理模型难以控制其思维链，这反而有助于AI安全** OpenAI 引入了一种名为 **CoT-Control**
  的技术，旨在测试推理模型是否能够自主监控并控制其自身的思维链过程。测试结果发现，现有的推理模型在试图有意识地引导或抑制其内部推理步骤时表现困难。这一发现被视为一个积极信
