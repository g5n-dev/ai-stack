...
description: 本文介绍了 Amazon Bedrock 发布的两项新 Amazon CloudWatch 指标，旨在提高推理工作负载的运营可见性。 **1.
  新指标概述** * **TimeToFirstToken (TTFT)**：衡量生成首个输出令牌的延迟。 * **EstimatedTPMQuotaUsage**：估算每分钟令
