...
- 开发工具
source: arxiv
description: 这篇文章介绍了一种**“神经调试器”**，旨在通过模拟传统调试器的功能，解决现有大语言模型（LLM）在代码执行层面缺乏交互控制的问题。以下是内容总结：
  **1. 背景与挑战** 现有的“神经解释器”虽然能逐行预测Python程序，但缺乏开发者常用的调试能力（如设置断点、单步执行、检查变量）。开发者需要能够控制执行流程的
