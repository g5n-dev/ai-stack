...
draft: false
entry_kind: "auto"
tags: ["联邦学习", "差分隐私", "可解释性", "XAI", "决策树", "FEXT-DP", "数据隐私", "机器学习"]
categories: ["论文", "安全"]
source: arxiv
description: "以下是该内容的中文总结： 这篇文章旨在解决现代机器学习系统中**数据隐私**与**可解释性（XAI）**相结合的挑战。为了在增强隐私保护的同时不牺牲模型的可解释性，作者提出了一种名为 **FEXT-DP（Federated EXplainable Trees with Differential Privacy）** 的"
