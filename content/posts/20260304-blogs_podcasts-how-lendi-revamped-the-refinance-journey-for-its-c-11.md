...
description: 这是一份关于 Lendi Group 如何利用 Amazon Bedrock 构建生成式 AI 应用的案例总结： **案例概览** Lendi
  Group 在短短 16 周内，利用 Amazon Bedrock 成功重构了客户的房贷再融资流程。他们开发了一款名为 **“Home Loan Guardian”**
  的智能
