...
MARS 全称为 **Margin-Aware Reward-Modeling with Self-Refinement**（基于边际感知的奖励建模与自我精炼）。它主要解决的是在大语言模型对齐过程中，现有奖励模型（Reward Model, RM）存在的**泛化能力不足**和**对困难样本区分度低**的问题。
...
MARS 与 RLHF 和 DPO 的主要区别在于**奖励模型的训练方式和数据来源**：
