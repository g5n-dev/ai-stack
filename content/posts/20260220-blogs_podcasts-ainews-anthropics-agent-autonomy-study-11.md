...
description: 在 AI 智能体从被动响应向主动决策演进的过程中，自主性能力的量化评估始终是行业难点。Anthropic 近期发布的内部 METR 数据研究，为我们提供了一个审视模型在复杂任务中规划与执行能力的窗口。本文将深入解读该研究的关键发现，分析智能体在处理长链路任务时的表现边界，并探讨其对未来
  AI 应用落地与安全对齐的实际意
