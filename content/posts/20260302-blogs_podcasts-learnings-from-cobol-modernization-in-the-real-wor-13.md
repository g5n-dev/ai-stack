...
description: '**内容总结：** 本文探讨了在现实世界中成功进行 COBOL 现代化的关键经验与要求。 核心观点指出，要成功交付 COBOL 现代化项目，必须同时依靠**逆向工程**和**正向工程**，并为此构建一套完整的解决方案。该解决方案的具体能力要求包括：
  1. **确定性逆向工程**：能够将旧系统代码进行确定性的逆向转换，而'
