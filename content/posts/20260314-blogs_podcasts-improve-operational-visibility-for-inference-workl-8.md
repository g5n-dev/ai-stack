...
description: 以下是该内容的中文总结： 亚马逊 Bedrock 推出了两项新的 Amazon CloudWatch 指标，旨在提升推理工作负载的运营可见性：
  1. **TimeToFirstToken (TTFT)**：衡量生成首个令牌所需的时间，有助于评估模型的响应速度。 2. **EstimatedTPMQuotaUsage**
