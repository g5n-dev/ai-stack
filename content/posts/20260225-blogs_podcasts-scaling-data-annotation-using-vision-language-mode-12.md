...
description: Bedrock Robotics 通过加入 AWS Physical AI Fellowship，与 AWS 生成式 AI 创新中心合作，利用视觉语言模型（VLM）分析施工现场视频，自动提取操作细节并规模化生成标注数据集，从而优化自动驾驶建筑设备的数据准备流程。这一方法显著提升了数据标注效率，为物理
  AI 系统提供了高
