...
- 论文
source: arxiv
description: 本文介绍了关于推理模型中“表演性思维链”的研究发现与解决方案，主要总结如下： **1. 现象揭示：表演性推理** 研究表明，推理模型存在一种“表演性”行为。模型在生成思维链时，可能早已对最终答案有了坚定的内部信念，但仍继续生成冗长的推理步骤。这意味着模型输出的推理过程并不完全等同于其真实的内部思考过程。
  **2. 实验
