...
description: 以下是对该内容的中文总结： **亚马逊云科技宣布在中东地区（阿联酋和巴林）推出针对 Anthropic Claude 模型的 Amazon
  Bedrock 全球跨区域推理功能。** 主要内容包括： 1. **可用模型**：客户现可使用 Anthropic 的多个 Claude 模型版本，包括 Opus
  4.6、Sonn
