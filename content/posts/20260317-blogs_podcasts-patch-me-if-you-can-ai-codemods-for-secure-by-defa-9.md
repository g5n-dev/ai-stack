...
description: 这篇文章介绍了 Meta 工程团队如何利用 **AI 代码自动化修改** 技术，在大规模 Android 开发中快速修复安全漏洞，从而打造“默认安全”的应用。
  **主要挑战：** 在拥有数百万行代码和数千名工程师的超大型代码库中，即使是简单的 API 更新或安全补丁，也会因为规模巨大而变得难以执行。手动修复不仅效率低下
