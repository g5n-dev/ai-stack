...
description: 这篇文章主要记录了 METR 研究员 Joel Becker 关于人工智能（AI）评估、威胁模型及 AI 生产力极限的见解，同时附带了 AIE
  活动的截稿提醒。以下是核心内容的总结： **1. METR 的评估重点：指数级时间地平线（Exponential Time Horizons）** * **核心挑战：**
  Be
