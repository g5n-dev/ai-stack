...
description: 本文介绍了如何利用 AWS 云开发工具包（AWS CDK）构建一个**智能照片搜索系统**。该系统整合了三项核心 AWS 服务，实现了从图像分析到关系映射，再到
  AI 生成描述的全流程自动化。 核心组件与功能 1. **图像分析（Amazon Rekognition）** * 利用 Rekognition 的 API
