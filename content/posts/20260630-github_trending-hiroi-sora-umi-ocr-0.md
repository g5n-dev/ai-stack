...
draft: false
entry_kind: "auto"
tags: ["离线OCR", "PDF识别", "二维码", "开源工具", "跨平台", "多语言", "Python", "批量处理"]
categories: ["开发工具", "开源生态"]
source: github_trending
description: "项目概述 Umi‑OCR（仓库 hiroi‑sora/Umi‑OCR）是一款开源、免费、离线的 OCR 工具，使用 Python 编写，GitHub 约 45,700 星。项目旨在提供无需网络的文字识别能力，支持截屏、批量图片、PDF 文档以及二维码处理。 核心功能 - **截屏 OCR**：快速捕获屏幕文本，适合即时"
