...
description: 随着 AI 系统能力的快速演进，如何准确评估其潜在风险与局限性已成为安全研究的核心议题。METR 研究员 Joel Becker 在本次访谈中深入探讨了指数级时间视界评估、威胁模型构建以及
  AI 生产力边界的最新观点。通过剖析技术细节与评估方法论，本文旨在帮助读者理解当前 AI 安全评测的挑战，并为相关研究提供切实可行
