...
description: 将自然界视为一台计算机，为材料科学引入了全新的计算范式。CuspAI 在获得 1 亿美元融资并组建了由图灵奖得主领衔的顾问团队后，正试图利用生成式
  AI 解决气候技术中的关键材料筛选难题。本文将深入探讨 Max Welling 教授如何通过算法加速新材料的发现与验证，帮助读者理解 AI 与基础科学结合所带来的产业变革与
