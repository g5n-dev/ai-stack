...
description: 这篇内容是a16z的通用技术合伙人Martin Casado和Sarah Wang关于当前AI投资格局、市场现状及未来趋势的深度对话总结。核心观点指出，虽然AI领域存在巨大的资本支出和基础设施泡沫风险，但“应用层”的黄金时代才刚刚开始。
  以下是关键要点总结： **1. 核心论点：从基础设施到应用的转变** * **基础
