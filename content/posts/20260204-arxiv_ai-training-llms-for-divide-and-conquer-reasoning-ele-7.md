...
draft: false
entry_kind: "auto"
tags: ["LLM", "推理", "强化学习", "分治法", "测试时扩展", "CoT", "模型训练", "算法优化"]
categories: ["大模型", "论文"]
source: arxiv
description: "本文介绍了一种旨在提升大语言模型（LLM）推理能力的新框架，该框架通过强化学习训练模型掌握“分而治之”的策略。 **主要观点如下：** 1. **现有方法的局限：** 尽管思维链赋予了模型逐步推理的能力，但在处理高难度问题时往往力不从心，且其严格的串行特性限制了测试时的扩展性。 2. **分而治之（DAC）的潜力与挑战"
