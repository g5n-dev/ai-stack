...
description: 本文介绍了如何利用 Union.ai 和 Flyte 在 Amazon EKS（Amazon Elastic Kubernetes Service）上构建可扩展的
  AI/ML 工作流。 主要内容总结如下： 1. **核心组件**：文章展示了如何使用 **Flyte Python SDK** 来编排和扩展机器学习工作流，
