...
description: OpenAI在研究其推理模型的思维链（CoT）控制能力时发现了一个有趣的现象：这些模型实际上**难以精确控制自身的思维链**。尽管这听起来像是技术上的局限，但OpenAI认为这实际上是**一件好事**，因为它强化了**“可监控性”**作为AI安全关键保障的地位。
  以下是关于这一发现的简洁总结： **1. 核心发现：模型
