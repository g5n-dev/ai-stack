...
draft: false
entry_kind: "auto"
tags: ["流匹配", "场蒸馏", "图像生成", "文本到图像", "速度场", "模型蒸馏", "多能力学习", "无分类器引导"]
categories: ["论文", "AI 工程"]
source: arxiv
description: "背景与挑战 当前图像生成模型需要同时具备文本到图像生成（T2I）、局部编辑、全局编辑等多能力，但这些能力在训练时往往相互冲突。例如，编辑会削弱原有的 T2I 性能，局部与全局编辑之间也会相互干扰，导致多能力统一训练成为难题。 方法概述 DanceOPD 提出一种基于流匹配模型的“生成场蒸馏”框架。核心思路是将每种能力定"
