...
description: 抵抗提示注入的智能体设计：ChatGPT 的防御机制 **核心目标** 该内容主要探讨了如何通过限制风险操作和在工作流中保护敏感数据，来设计能够抵御“提示注入”和“社会工程学”攻击的
  AI 智能体，并以 ChatGPT 为例进行了具体说明。 **主要防御策略** **1. 限制风险操作** 为了防止 AI 被恶意指令诱
