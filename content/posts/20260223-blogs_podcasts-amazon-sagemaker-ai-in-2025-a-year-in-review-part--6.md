...
description: 以下是对该内容的中文总结： 本文回顾了 Amazon SageMaker AI 在 2025 年取得的关键进展，主要聚焦于核心基础设施在**容量**和**性价比**两个维度的提升：
  1. **容量提升与灵活训练计划：** 文章重点介绍了“灵活训练计划”的推出，旨在显著提升系统的容量能力，以满足用户对训练资源的需求。 2
