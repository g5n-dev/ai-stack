...
description: 本文介绍了如何在 Amazon SageMaker AI 和 Amazon Bedrock 上，利用 vLLM 高效托管多个微调模型，重点阐述了针对混合专家模型的多
  LoRA 推理实现及内核级优化。 **核心内容总结如下：** 1. **多 LoRA 推理实现**： 文章详细说明了如何在 vLLM 框架内为 MoE 模
