...
description: 本文是对 Amazon SageMaker AI 2025 年度回顾的第二部分总结，重点介绍了其在**可观测性**、**模型定制**以及**模型托管**方面的功能增强。
  以下是主要内容的简要总结： **1. 增强的可观测性** SageMaker AI 在 2025 年引入了更强大的监控和调试工具，帮助用户更好地了解生
