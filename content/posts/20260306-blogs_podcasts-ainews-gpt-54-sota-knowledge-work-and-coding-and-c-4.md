...
description: 以下是该内容的中文简洁总结： **标题：[AINews] GPT 5.4：登顶SOTA的知识工作、编程及CUA模型，OpenAI强势回归**
  **核心概述：** OpenAI发布了全新的GPT 5.4模型，这标志着OpenAI的强势回归，被视为一次巨大的胜利。该版本在三个关键领域实现了突破，确立了新的行业最高标准（SO
