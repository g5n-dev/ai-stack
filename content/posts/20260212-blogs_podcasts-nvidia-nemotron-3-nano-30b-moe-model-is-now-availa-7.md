...
draft: false
entry_kind: "auto"
tags: ["NVIDIA", "AWS", "SageMaker", "Nemotron", "MoE", "模型部署", "推理优化", "生成式AI"]
categories: ["大模型", "系统与基础设施"]
source: blogs_podcasts
description: "NVIDIA 宣布其 **Nemotron 3 Nano 30B** 模型现已正式登陆 **Amazon SageMaker JumpStart**。 该模型采用 **混合专家（MoE）** 架构，拥有 **30B** 总参数量，但在实际推理过程中仅激活 **3B** 参数。通过 SageMaker JumpStart"
