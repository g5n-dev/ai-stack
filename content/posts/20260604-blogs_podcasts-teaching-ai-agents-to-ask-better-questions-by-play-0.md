...
draft: false
entry_kind: "auto"
tags: ["AI智能体", "海战棋", "小模型", "成本优化", "模型微调", "MIT研究", "提问策略", "语言模型"]
categories: ["AI 工程", "效率与方法论"]
source: blogs_podcasts
description: "研究背景 MIT团队选择经典的海战棋（Battleship）作为AI代理提问能力的测试平台。该游戏规则简单、状态空间可控，能够在受限信息下评估代理通过提问获取关键数据的效果。 研究发现 实验对比了不同规模的语言模型在海战棋中的表现。结果显示，经过针对性微调的小型模型（仅数十亿参数）在提问效率和定位准确率上可媲美甚至超越"
