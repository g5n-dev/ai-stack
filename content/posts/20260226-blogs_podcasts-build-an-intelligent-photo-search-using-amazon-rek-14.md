...
description: 本文介绍如何利用 **AWS CDK** 构建一个智能照片搜索系统。该系统通过集成三项核心 AWS 服务，实现了从图像分析到语义理解再到关系映射的全面功能：
  1. **Amazon Rekognition**：用于**视觉分析**，自动检测照片中的人脸和物体。 2. **Amazon Bedrock**：利用 AI
  生
