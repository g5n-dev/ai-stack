...
description: 本文介绍了如何利用 Union.ai 和 Flyte 在 Amazon EKS 上构建和扩展 AI 工作流。 主要内容总结如下： 1. **核心组件**：利用
  **Flyte Python SDK** 来编排和扩展机器学习工作流。 2. **部署架构**：**Union.ai 2.0** 系统支持将 Flyte 部署在
