...
```mermaid
graph LR
    A[开发者本地] -->|git push| B[GitHub Main 分支]
    B -->|触发| C[GitHub Actions]
    C -->|1. Checkout| D[代码]
    C -->|2. Setup| E[Python + Hugo]
    C -->|3. Generate| F[爬取 + AI]
    C -->|4. Build| G[Hugo 静态站]
    C -->|5. Deploy| H[gh-pages 分支]
    H -->|Publish| I[GitHub Pages]
    I -->|DNS| J[ai-stack 域名]
```
    ...
    steps:
      ...
      - name: Deploy to GitHub Pages
        ...
        with:
          ...
          commit_message: '🤖 Auto deploy from workflow'
          cname: ai-stack  # 自定义域名

      - name: Notify Success
        if: success()
        run: |
          echo "✅ Deployment successful"
          echo "🌐 Site: https://ai-stack"
...
| Secret 名称 | 说明 | 示例值 |
|-------------|------|---------|
| `ANTHROPIC_AUTH_TOKEN` | Anthropic API 密钥 | `sk-ant-xxx` |
...
[params]
  ...
  author = "AI Stack Bot"
  github = "https://github.com/YOUR_USERNAME/ai-stack"
