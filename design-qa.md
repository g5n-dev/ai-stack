...
验收日期：2026-07-17
验收分支：`codex/overview-topology-refresh`
...
- Node：99 tests passed。
- Python 3.12（排除需要独立浏览器产物的 E2E fixture）：811 passed，85 subtests passed。
- Hugo 0.153.4：生产构建通过；`/scenarios/`、`/trends/` 与首页产物存在。
- Pagefind 与安全结果目录：1,960 篇文章、52,180 个词，catalog 与 manifest 构建通过。
