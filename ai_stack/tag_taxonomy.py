"""Deterministic, conservative tag taxonomy normalization.

This module is the canonical taxonomy boundary for collection, generation,
historical repair, and graph projection.  Compatibility imports under
``processor.taxonomy_normalizer`` intentionally forward to this module.
